...
public class JobshunterguiMenu extends AbstractContainerMenu implements PalamodModMenus.MenuAccessor {
	...
	public JobshunterguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PalamodModMenus.JOBSHUNTERGUI.get(), id);
