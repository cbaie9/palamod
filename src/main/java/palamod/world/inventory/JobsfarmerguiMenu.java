...
public class JobsfarmerguiMenu extends AbstractContainerMenu implements PalamodModMenus.MenuAccessor {
	...
	public JobsfarmerguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PalamodModMenus.JOBSFARMERGUI.get(), id);
