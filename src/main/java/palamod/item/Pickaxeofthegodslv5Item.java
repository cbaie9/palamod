...
public class Pickaxeofthegodslv5Item extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 0, 16f, 0, 32, TagKey.create(Registries.ITEM, Identifier.parse("palamod:pickaxe_of_the_gods_lv5_repair_items")));
	...
	public static void modifyDefaultComponents(ModifyDefaultComponentsEvent event) {
		event.modify(PalamodModItems.PICKAXE_OF_THE_GODS_LV5.get(), (builder, _, _) -> builder.set(DataComponents.MAX_DAMAGE, null));
	}
