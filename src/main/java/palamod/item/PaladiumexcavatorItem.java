...
public class PaladiumexcavatorItem extends ShovelItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 4999, 18f, 0, 23, TagKey.create(Registries.ITEM, Identifier.parse("palamod:paladium_excavator_repair_items")));
