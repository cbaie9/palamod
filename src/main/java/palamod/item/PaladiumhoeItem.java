...
public class PaladiumhoeItem extends HoeItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 5000, 4f, 0, 2, TagKey.create(Registries.ITEM, Identifier.parse("palamod:paladium_hoe_repair_items")));
