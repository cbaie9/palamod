...
public abstract class Paladiumarmorcustom3Item extends Item {
...
<<<<<<< Updated upstream
			DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_diamond")), 3.5f, 0.15f, TagKey.create(Registries.ITEM, ResourceLocation.parse("palamod:paladiumarmorcustom_3_repair_items")),
			ResourceKey.create(EquipmentAssets.ROOT_ID, ResourceLocation.parse("palamod:paladiumarmorcustom_3")));
=======
			DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_diamond")), 3.5f, 0.15f, TagKey.create(Registries.ITEM, ResourceLocation.parse("palamod:paladium_armor_custom3_repair_items")),
			ResourceKey.create(EquipmentAssets.ROOT_ID, ResourceLocation.parse("palamod:paladium_armor_custom3")));
>>>>>>> Stashed changes

	private Paladiumarmorcustom3Item(Item.Properties properties) {
		super(properties);
	}
