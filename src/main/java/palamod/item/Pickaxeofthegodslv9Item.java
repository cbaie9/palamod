...
public class Pickaxeofthegodslv9Item extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 0, 30f, 0, 10, TagKey.create(Registries.ITEM, Identifier.parse("palamod:pickaxe_of_the_gods_lv9_repair_items")));
	...
	public static void modifyDefaultComponents(ModifyDefaultComponentsEvent event) {
		event.modify(PalamodModItems.PICKAXE_OF_THE_GODS_LV9.get(), (builder, _, _) -> builder.set(DataComponents.MAX_DAMAGE, null));
	}
