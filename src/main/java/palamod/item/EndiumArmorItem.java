...
public abstract class EndiumArmorItem extends Item {
	public static ArmorMaterial ARMOR_MATERIAL = new ArmorMaterial(400, Map.of(ArmorType.BOOTS, 10, ArmorType.LEGGINGS, 6, ArmorType.CHESTPLATE, 12, ArmorType.HELMET, 10, ArmorType.BODY, 12), 70,
			DeferredHolder.create(Registries.SOUND_EVENT, Identifier.parse("item.armor.equip_netherite")), 5f, 0.3f, TagKey.create(Registries.ITEM, Identifier.parse("palamod:endium_armor_repair_items")),
			ResourceKey.create(EquipmentAssets.ROOT_ID, Identifier.parse("palamod:endium_armor")));
