...
public class AmethystehammerItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 2999, 1f, 0, 1, TagKey.create(Registries.ITEM, ResourceLocation.parse("palamod:amethyst_hammer_repair_items")));
