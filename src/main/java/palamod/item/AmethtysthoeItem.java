...
public class AmethtysthoeItem extends HoeItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 3000, 4f, 0, 2, TagKey.create(Registries.ITEM, ResourceLocation.parse("palamod:amethyst_hoe_repair_items")));

	public AmethtysthoeItem(Item.Properties properties) {
