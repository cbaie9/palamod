...
@EventBusSubscriber
public class Pickaxeofthegodslv3Item extends Item {
<<<<<<< Updated upstream
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 0, 6f, 0, 14, TagKey.create(Registries.ITEM, ResourceLocation.parse("palamod:pickaxeofthegodslv_3_repair_items")));
=======
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 0, 6f, 0, 14, TagKey.create(Registries.ITEM, ResourceLocation.parse("palamod:pickaxe_of_the_gods_lv3_repair_items")));
>>>>>>> Stashed changes

	public Pickaxeofthegodslv3Item(Item.Properties properties) {
		super(TOOL_MATERIAL.applyToolProperties(properties, BlockTags.MINEABLE_WITH_PICKAXE, 3f, -2.8f, 0)
...
<<<<<<< Updated upstream
		componentConsumer.accept(Component.translatable("item.palamod.pickaxeofthegodslv_3.description_0"));
=======
