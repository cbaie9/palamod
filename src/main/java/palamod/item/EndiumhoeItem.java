...
public class EndiumhoeItem extends HoeItem {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 10000, 4f, 0, 2, TagKey.create(Registries.ITEM, ResourceLocation.parse("palamod:endium_hoe_repair_items")));

	public EndiumhoeItem(Item.Properties properties) {
