...
public class StickofgodsItem extends Item {
	public StickofgodsItem(Item.Properties properties) {
		super(properties.durability(8).attributes(ItemAttributeModifiers.builder().add(Attributes.ATTACK_DAMAGE, new AttributeModifier(BASE_ATTACK_DAMAGE_ID, 0, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND)
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		StickofgodsprocessProcedure.execute(world, entity, entity.getItemInHand(hand));
		return ar;
	}
