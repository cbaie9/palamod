...
@EventBusSubscriber
public class Pickaxeofthegodslv6Item extends Item {
<<<<<<< Updated upstream
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 0, 14f, 0, 30, TagKey.create(Registries.ITEM, ResourceLocation.parse("palamod:pickaxeofthegodslv_6_repair_items")));
=======
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 0, 14f, 0, 30, TagKey.create(Registries.ITEM, ResourceLocation.parse("palamod:pickaxe_of_the_gods_lv6_repair_items")));
>>>>>>> Stashed changes

	public Pickaxeofthegodslv6Item(Item.Properties properties) {
...
<<<<<<< Updated upstream
		componentConsumer.accept(Component.translatable("item.palamod.pickaxeofthegodslv_6.description_0"));
=======
