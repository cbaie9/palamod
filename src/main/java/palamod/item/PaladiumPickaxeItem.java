...
public class PaladiumPickaxeItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 4999, 30f, 0, 10, TagKey.create(Registries.ITEM, Identifier.parse("palamod:paladium_pickaxe_repair_items")));
