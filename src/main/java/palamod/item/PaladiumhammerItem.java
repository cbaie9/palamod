...
public class PaladiumhammerItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 3999, 8f, 0, 1, TagKey.create(Registries.ITEM, ResourceLocation.parse("palamod:paladium_hammer_repair_items")));
