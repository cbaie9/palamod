...
public class JobscommandCommand {
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("jobs").requires(s -> s.hasPermission(2)).then(Commands.literal("miner").then(Commands.literal("gui").then(Commands.literal("craft").executes(arguments -> {
			...
			return 0;
		}))).then(Commands.literal("set").then(Commands.argument("num", DoubleArgumentType.doubleArg()).then(Commands.literal("levels").executes(arguments -> {
			Level world = arguments.getSource().getUnsidedLevel();
			double x = arguments.getSource().getPosition().x();
			double y = arguments.getSource().getPosition().y();
			double z = arguments.getSource().getPosition().z();
			...
			return 0;
		}))))).then(Commands.literal("farmer").then(Commands.literal("gui").then(Commands.literal("craft").executes(arguments -> {
			Level world = arguments.getSource().getUnsidedLevel();
			double x = arguments.getSource().getPosition().x();
			double y = arguments.getSource().getPosition().y();
			double z = arguments.getSource().getPosition().z();
