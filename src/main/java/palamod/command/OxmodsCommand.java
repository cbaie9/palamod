	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("oxmods")
				...
				.then(Commands.literal("uuid").executes(arguments -> {
					...
					return 0;
				})).then(Commands.literal("jobs").then(Commands.literal("max").executes(arguments -> {
					Level world = arguments.getSource().getUnsidedLevel();
					double x = arguments.getSource().getPosition().x();
					double y = arguments.getSource().getPosition().y();
					double z = arguments.getSource().getPosition().z();
					...
					MaxJobsOxmodProcedure.execute(world, x, y, z, entity);
					return 0;
					...
					GetLevelCommandJobsCommandVerProcedure.execute(world, x, y, z, arguments, entity);
					return 0;
					...
					return 0;
				})).then(Commands.literal("copycomponant").executes(arguments -> {
					Level world = arguments.getSource().getUnsidedLevel();
					double x = arguments.getSource().getPosition().x();
					double y = arguments.getSource().getPosition().y();
					double z = arguments.getSource().getPosition().z();
