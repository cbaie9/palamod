...
public class HomeprocessbaseProcedure {
		...
		if (entity.getPersistentData().getBoolean((StringArgumentType.getString(arguments, "home_name"))) == true) {
			{
				...
				_ent.teleportTo((entity.getPersistentData().getDouble(("home_" + StringArgumentType.getString(arguments, "home_name") + "_x"))),
						(entity.getPersistentData().getDouble(("home_" + StringArgumentType.getString(arguments, "home_name") + "_y"))), (entity.getPersistentData().getDouble(("home_" + StringArgumentType.getString(arguments, "home_name") + "_z"))));
