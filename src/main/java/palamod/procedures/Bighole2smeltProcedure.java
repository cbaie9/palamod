		...
		if (entity.getXRot() > 40 || entity.getXRot() < -40) {
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z - 2))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x, y, z - 2))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level112
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x, y, z - 2))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
			...
			if ((world.getBlockState(BlockPos.containing(x + 2, y, z - 1))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x + 2, y, z - 1))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level138
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x + 2, y, z - 1))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
			...
			if ((world.getBlockState(BlockPos.containing(x + 3, y, z + 1))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x + 3, y, z + 1))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level164
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x + 3, y, z + 1))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
			...
			if ((world.getBlockState(BlockPos.containing(x + 3, y, z - 2))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x + 3, y, z - 2))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level190
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x + 3, y, z - 2))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
			...
			if ((world.getBlockState(BlockPos.containing(x + 2, y, z + 2))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x + 2, y, z + 2))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level216
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x + 2, y, z + 2))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
			...
			if ((world.getBlockState(BlockPos.containing(x + 1, y, z - 2))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x + 1, y, z - 2))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level242
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x + 1, y, z - 2))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
			...
			if ((world.getBlockState(BlockPos.containing(x + 2, y, z))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x + 2, y, z))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level320
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x + 2, y, z))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
			...
			if ((world.getBlockState(BlockPos.containing(x + 3, y, z))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x + 3, y, z))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level333
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x + 3, y, z))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
			...
			if ((world.getBlockState(BlockPos.containing(x, y + 2, z))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x, y + 2, z))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level454
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x, y + 2, z))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
			...
			if ((world.getBlockState(BlockPos.containing(x, y + 3, z))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x, y + 3, z))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level467
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x, y + 3, z))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
			...
			if ((world.getBlockState(BlockPos.containing(x + 2, y + 3, z))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x + 2, y + 3, z))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level480
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x + 2, y + 3, z))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
			...
			if ((world.getBlockState(BlockPos.containing(x + 1, y + 3, z))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x + 1, y + 3, z))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level493
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x + 1, y + 3, z))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
			...
			if ((world.getBlockState(BlockPos.containing(x - 2, y + 2, z))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x - 2, y + 2, z))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level532
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x - 2, y + 2, z))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
			...
			if ((world.getBlockState(BlockPos.containing(x + 1, y + 2, z))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x + 1, y + 2, z))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level558
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x + 1, y + 2, z))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
			...
			if ((world.getBlockState(BlockPos.containing(x - 2, y + 1, z))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x - 2, y + 1, z))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level584
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x - 2, y + 1, z))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
			...
			if ((world.getBlockState(BlockPos.containing(x, y + 2, z - 1))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x, y + 2, z - 1))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level809
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x, y + 2, z - 1))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
			...
			if ((world.getBlockState(BlockPos.containing(x, y + 3, z + 1))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x, y + 3, z + 1))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level835
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x, y + 3, z + 1))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
			...
			if ((world.getBlockState(BlockPos.containing(x, y + 3, z - 2))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x, y + 3, z - 2))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level887
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x, y + 3, z - 2))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
			...
			if ((world.getBlockState(BlockPos.containing(x, y + 2, z - 2))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x, y + 2, z - 2))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level900
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x, y + 2, z - 2))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
			...
			if ((world.getBlockState(BlockPos.containing(x, y + 1, z - 2))).is(BlockTags.create(ResourceLocation.parse("minecraft:mineable/pickaxe"))) && !((world.getBlockState(BlockPos.containing(x, y + 1, z - 2))).getBlock() == Blocks.BEDROCK)) {
				if (world instanceof ServerLevel _level913
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, (getItemStackFromItemStackSlot(world, (new ItemStack((world.getBlockState(BlockPos.containing(x, y + 1, z - 2))).getBlock())))));
						entityToSpawn.setPickUpDelay(10);
						_level.addFreshEntity(entityToSpawn);
					}
