	...
	public static void execute(Entity entity) {
		...
		if (hasEntityInInventory(entity, new ItemStack(Blocks.COBBLESTONE)) && (getAmountInGUISlot(entity, 0) == 0
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack7 = new ItemStack(Blocks.COBBLESTONE).copy();
		...
		if (hasEntityInInventory(entity, new ItemStack(Blocks.COBBLESTONE)) && (getAmountInGUISlot(entity, 2) == 0
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack15 = new ItemStack(Blocks.COBBLESTONE).copy();
		...
		if (hasEntityInInventory(entity, new ItemStack(Blocks.COBBLESTONE)) && (getAmountInGUISlot(entity, 6) == 0
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack23 = new ItemStack(Blocks.COBBLESTONE).copy();
		...
		if (hasEntityInInventory(entity, new ItemStack(PalamodModItems.FORTUNE_MODIFIER.get())) && (getAmountInGUISlot(entity, 7) == 0
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack31 = new ItemStack(PalamodModItems.FORTUNE_MODIFIER.get()).copy();
		...
		if (hasEntityInInventory(entity, new ItemStack(Blocks.COBBLESTONE)) && (getAmountInGUISlot(entity, 8) == 0
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack39 = new ItemStack(Blocks.COBBLESTONE).copy();
				_setstack39.setCount(getAmountInGUISlot(entity, 8) + 1);
				_menu.getSlots().get(8).set(_setstack39);
				_player.containerMenu.broadcastChanges();
			}
		}
		if (hasEntityInInventory(entity, new ItemStack(Blocks.COBBLESTONE))
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack47 = new ItemStack(Blocks.COBBLESTONE).copy();
				_setstack47.setCount(getAmountInGUISlot(entity, 3) + 1);
				_menu.getSlots().get(3).set(_setstack47);
				_player.containerMenu.broadcastChanges();
			}
		}
		...
		if (hasEntityInInventory(entity, new ItemStack(Blocks.COBBLESTONE))
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack63 = new ItemStack(Blocks.COBBLESTONE).copy();
