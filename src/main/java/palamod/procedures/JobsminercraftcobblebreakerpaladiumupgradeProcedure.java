...
public class JobsminercraftcobblebreakerpaladiumupgradeProcedure {
	public static void execute(Entity entity) {
			...
			return;
		{
			...
			_vars.lvl_required = "Lvl required : 16";
			_vars.markSyncDirty();
		}
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			...
			_menu.getSlots().get(8).set(_setstack3);
			ItemStack _setstack4 = new ItemStack(PalamodModItems.PALADIUM_INGOT.get()).copy();
			_setstack4.setCount(1);
			_menu.getSlots().get(3).set(_setstack4);
			ItemStack _setstack5 = new ItemStack(PalamodModItems.COBBLEBREAKER_TITANE_UPGRADE.get()).copy();
			_setstack5.setCount(1);
			_menu.getSlots().get(4).set(_setstack5);
			ItemStack _setstack6 = new ItemStack(PalamodModItems.PALADIUM_INGOT.get()).copy();
			_setstack6.setCount(1);
			_menu.getSlots().get(5).set(_setstack6);
			ItemStack _setstack7 = new ItemStack(PalamodModItems.COBBLEBREAKER_PALADIUM_UPGRADE.get()).copy();
