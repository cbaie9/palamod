...
public class JobsminerfarmergreenpaladiumhoeProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			...
			ItemStack _setstack1 = new ItemStack(PalamodModItems.GREEN_PALADIUM_INGOT.get()).copy();
			...
			ItemStack _setstack4 = new ItemStack(PalamodModItems.GREEN_PALADIUM_HOE.get()).copy();
