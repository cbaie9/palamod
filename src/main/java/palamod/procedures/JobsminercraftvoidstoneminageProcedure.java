...
public class JobsminercraftvoidstoneminageProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			...
			ItemStack _setstack3 = new ItemStack(PalamodModBlocks.TITANE_CHEST.get()).copy();
			_setstack3.setCount(1);
			_menu.getSlots().get(7).set(_setstack3);
			ItemStack _setstack4 = new ItemStack(PalamodModItems.VOIDSTONE.get()).copy();
			_setstack4.setCount(1);
			_menu.getSlots().get(4).set(_setstack4);
			ItemStack _setstack5 = new ItemStack(PalamodModItems.MINAGE_VOIDSTONE.get()).copy();
