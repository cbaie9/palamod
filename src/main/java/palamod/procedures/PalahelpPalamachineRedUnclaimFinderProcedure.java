...
public class PalahelpPalamachineRedUnclaimFinderProcedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		ItemStack damaged_item = ItemStack.EMPTY;
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			ItemStack _setstack0 = new ItemStack(PalamodModItems.FINDIUM.get()).copy();
			_setstack0.setCount(1);
			_menu.getSlots().get(0).set(_setstack0);
			ItemStack _setstack1 = new ItemStack(PalamodModItems.PALADIUM_CORE.get()).copy();
			_setstack1.setCount(1);
			_menu.getSlots().get(1).set(_setstack1);
			ItemStack _setstack2 = new ItemStack(PalamodModItems.UNCLAIM_FINDER_ORANGE.get()).copy();
			_setstack2.setCount(1);
			_menu.getSlots().get(2).set(_setstack2);
			ItemStack _setstack3 = new ItemStack(PalamodModItems.FINDIUM.get()).copy();
			...
			ItemStack _setstack5 = new ItemStack(PalamodModItems.UNCLAIM_FINDER_RED.get()).copy();
		...
		entity.getPersistentData().putDouble("mode_palamachine_craft", 20);
	}
}