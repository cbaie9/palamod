	...
	public static void execute(Entity entity) {
		...
		if (hasEntityInInventory(entity, new ItemStack(Blocks.BRICKS)) && (getAmountInGUISlot(entity, 0) == 0
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack7 = new ItemStack(Blocks.BRICKS).copy();
		...
		if (hasEntityInInventory(entity, new ItemStack(PalamodModBlocks.PALADIUM_FURNACE.get()))
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack15 = new ItemStack(PalamodModBlocks.PALADIUM_FURNACE.get()).copy();
		...
		if (hasEntityInInventory(entity, new ItemStack(Blocks.BRICKS)) && (getAmountInGUISlot(entity, 2) == 0
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack23 = new ItemStack(Blocks.BRICKS).copy();
		...
		if (hasEntityInInventory(entity, new ItemStack(Blocks.BRICKS)) && (getAmountInGUISlot(entity, 6) == 0
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack31 = new ItemStack(Blocks.BRICKS).copy();
		...
		if (hasEntityInInventory(entity, new ItemStack(PalamodModBlocks.PALADIUM_FURNACE.get()))
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack39 = new ItemStack(PalamodModBlocks.PALADIUM_FURNACE.get()).copy();
		...
		if (hasEntityInInventory(entity, new ItemStack(Blocks.BRICKS)) && (getAmountInGUISlot(entity, 8) == 0
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack47 = new ItemStack(Blocks.BRICKS).copy();
		...
		if (hasEntityInInventory(entity, new ItemStack(PalamodModBlocks.PALADIUM_FURNACE.get()))
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack55 = new ItemStack(PalamodModBlocks.PALADIUM_FURNACE.get()).copy();
		...
		if (hasEntityInInventory(entity, new ItemStack(PalamodModBlocks.PALADIUM_FURNACE.get()))
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack71 = new ItemStack(PalamodModBlocks.PALADIUM_FURNACE.get()).copy();
