...
public class JobsfarmercraftamethystbackpackProcedure {
	public static void execute(Entity entity) {
		...
		if ((entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(PalamodModBlocks.AMETHYST_CHEST.get())) : false)
		...
		if ((entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(PalamodModItems.AMETHYST.get())) : false) && (getAmountInGUISlot(entity, 7) == 0
