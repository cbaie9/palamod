...
public class JobsminerfarmerendiumhoeProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			ItemStack _setstack0 = new ItemStack(PalamodModItems.ENDIUM_NUGGET.get()).copy();
			_setstack0.setCount(1);
			_menu.getSlots().get(1).set(_setstack0);
			ItemStack _setstack1 = new ItemStack(PalamodModItems.ENDIUM_NUGGET.get()).copy();
			...
			ItemStack _setstack4 = new ItemStack(PalamodModItems.ENDIUM_HOE.get()).copy();
