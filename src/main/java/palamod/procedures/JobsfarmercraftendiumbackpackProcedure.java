...
public class JobsfarmercraftendiumbackpackProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			...
			ItemStack _setstack1 = new ItemStack(PalamodModBlocks.PALADIUM_CHEST.get()).copy();
			...
			ItemStack _setstack9 = new ItemStack(PalamodModItems.ENDIUM_BACKPACK.get()).copy();
