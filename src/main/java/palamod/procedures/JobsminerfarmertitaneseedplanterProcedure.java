...
public class JobsminerfarmertitaneseedplanterProcedure {
	public static void execute(Entity entity) {
			...
			return;
		{
			...
			_vars.lvl_required = "Lvl required : 6";
			_vars.markSyncDirty();
		}
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			...
			ItemStack _setstack1 = new ItemStack(PalamodModItems.COMPRESSED_TITANE.get()).copy();
			...
			ItemStack _setstack4 = new ItemStack(PalamodModItems.AMETHYST_SEEDPLANTER.get()).copy();
			...
			ItemStack _setstack6 = new ItemStack(PalamodModItems.TITANE_STICK.get()).copy();
			_setstack6.setCount(1);
			_menu.getSlots().get(6).set(_setstack6);
			ItemStack _setstack7 = new ItemStack(PalamodModItems.TITANE_STICK.get()).copy();
			_setstack7.setCount(1);
			_menu.getSlots().get(7).set(_setstack7);
			ItemStack _setstack8 = new ItemStack(PalamodModItems.TITANE_STICK.get()).copy();
			_setstack8.setCount(1);
			_menu.getSlots().get(8).set(_setstack8);
			ItemStack _setstack9 = new ItemStack(PalamodModItems.TITANE_SEEDPLANTER.get()).copy();
