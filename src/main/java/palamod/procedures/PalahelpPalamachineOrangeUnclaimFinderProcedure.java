...
public class PalahelpPalamachineOrangeUnclaimFinderProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			...
			ItemStack _setstack1 = new ItemStack(PalamodModItems.FINDIUM.get()).copy();
			_setstack1.setCount(1);
			_menu.getSlots().get(1).set(_setstack1);
			ItemStack _setstack2 = new ItemStack(PalamodModItems.UNCLAIM_FINDER.get()).copy();
			...
			ItemStack _setstack5 = new ItemStack(PalamodModItems.UNCLAIM_FINDER_ORANGE.get()).copy();
		...
		entity.getPersistentData().putDouble("mode_palamachine_craft", 19);
	}
}