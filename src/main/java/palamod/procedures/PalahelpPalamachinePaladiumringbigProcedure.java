...
public class PalahelpPalamachinePaladiumringbigProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		ItemStack damaged_item = ItemStack.EMPTY;
		if (4 == entity.getPersistentData().getDouble("mode_palamachine_craft")) {
			damaged_item = new ItemStack(PalamodModItems.BIG_RING.get()).copy();
			if (world instanceof ServerLevel _level) {
				damaged_item.hurtAndBreak(50, _level, null, _stkprov -> {
				});
			}
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack2 = new ItemStack(PalamodModBlocks.PALADIUM_BLOCK.get()).copy();
				...
				ItemStack _setstack7 = new ItemStack(PalamodModItems.BIG_RING.get()).copy();
			...
			entity.getPersistentData().putDouble("mode_palamachine_craft", 5);
		} else {
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				...
				ItemStack _setstack20 = new ItemStack(PalamodModItems.MEDIUM_RING.get()).copy();
				...
				ItemStack _setstack23 = new ItemStack(PalamodModItems.BIG_RING.get()).copy();
			...
			entity.getPersistentData().putDouble("mode_palamachine_craft", 4);
		}
	}
}