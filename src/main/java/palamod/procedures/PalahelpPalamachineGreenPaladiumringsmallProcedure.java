...
public class PalahelpPalamachineGreenPaladiumringsmallProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		ItemStack damaged_item = ItemStack.EMPTY;
		if (6 == entity.getPersistentData().getDouble("mode_palamachine_craft")) {
			damaged_item = new ItemStack(PalamodModItems.GREEN_PALADIUM_SMALL_RING.get()).copy();
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				...
				ItemStack _setstack3 = new ItemStack(PalamodModItems.GREEN_PALADIUM_INGOT.get()).copy();
				...
				ItemStack _setstack7 = new ItemStack(PalamodModItems.GREEN_PALADIUM_SMALL_RING.get()).copy();
			...
			entity.getPersistentData().putDouble("mode_palamachine_craft", 7);
		} else {
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				...
				ItemStack _setstack20 = new ItemStack(PalamodModBlocks.PALADIUM_GREEN_BLOCK.get()).copy();
				_setstack20.setCount(1);
				_menu.getSlots().get(2).set(_setstack20);
				ItemStack _setstack21 = new ItemStack(PalamodModItems.GREEN_PALADIUM_INGOT.get()).copy();
				...
				ItemStack _setstack23 = new ItemStack(PalamodModItems.GREEN_PALADIUM_SMALL_RING.get()).copy();
			...
			entity.getPersistentData().putDouble("mode_palamachine_craft", 6);
		}
	}
}