...
public class JobsminercraftcobblebreakeramethysteupgradeProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			...
			ItemStack _setstack1 = new ItemStack(PalamodModBlocks.COBBLEBREAKER.get()).copy();
			...
			ItemStack _setstack4 = new ItemStack(PalamodModItems.SPEED_MODIFIER.get()).copy();
			...
			ItemStack _setstack6 = new ItemStack(PalamodModItems.AMETHYST_INGOT.get()).copy();
			...
			ItemStack _setstack8 = new ItemStack(PalamodModItems.COBBLEBREAKER_AMETHYST_UPGRADE.get()).copy();
