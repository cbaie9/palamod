...
public class JobsminercraftendiumtntProcedure {
	public static void execute(Entity entity) {
		...
		if ((entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(PalamodModItems.ENDIUM_NUGGET.get())) : false) && (getAmountInGUISlot(entity, 4) == 0
