...
public class JobsminercraftspongetntProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			...
			ItemStack _setstack6 = new ItemStack(PalamodModBlocks.COMPRESSED_SPONGE.get()).copy();
			...
			ItemStack _setstack8 = new ItemStack(PalamodModBlocks.COMPRESSED_SPONGE.get()).copy();
