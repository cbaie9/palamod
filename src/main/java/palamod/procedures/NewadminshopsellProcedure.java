	...
	public static void execute(LevelAccessor world, Entity entity) {
		...
		money = ReadMoneyFileProcedure.execute(entity);
		{
			try {
				...
				if (((entity instanceof Player _entity10 && _entity10.containerMenu instanceof PalamodModMenus.MenuAccessor _menu10) ? _menu10.getMenuState(0, "number_buy", "") : "").toLowerCase().contains("max")) {
					if (entity instanceof Player _player) {
