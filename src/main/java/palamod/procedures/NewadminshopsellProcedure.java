...
public class NewadminshopsellProcedure {
			...
			try {
				...
				if (n == 0) {
					...
					if (entity instanceof Player _player && !_player.level().isClientSide())
						_player.displayClientMessage(Component.literal((Component.translatable("palamod.adminshop_sell_1").getString())), false);
				}
				...
				if (((entity instanceof Player _entity13 && _entity13.containerMenu instanceof PalamodModMenus.MenuAccessor _menu13) ? _menu13.getMenuState(0, "number_buy", "") : "").toLowerCase().contains("max")) {
					if (entity instanceof Player _player) {
					...
					if (entity instanceof Player _player && !_player.level().isClientSide())
						_player.displayClientMessage(Component.literal((Component.translatable("palamod.adminshop_sell_2").getString() + " " + n2 + " " + Component.translatable("palamod.adminshop_sell_3").getString())), false);
				} else if (n <= n2) {
					...
					if (entity instanceof Player _player && !_player.level().isClientSide())
						_player.displayClientMessage(Component.literal((Component.translatable("palamod.adminshop_sell_2").getString() + " " + n + " " + Component.translatable("palamod.adminshop_sell_3").getString())), false);
				} else {
					if (entity instanceof Player _player)
						_player.closeContainer();
					if (entity instanceof Player _player && !_player.level().isClientSide())
						_player.displayClientMessage(Component.literal((Component.translatable("palamod.adminshop_sell_4").getString())), false);
				}
			} catch (IOException e) {
				e.printStackTrace();
			}
