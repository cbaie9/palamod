...
public class JobsminercraftcobblebreakertitaneupgradeProcedure {
	public static void execute(Entity entity) {
		...
		if (hasEntityInInventory(entity, new ItemStack(PalamodModItems.TITANE_INGOT.get()))
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack39 = new ItemStack(PalamodModItems.TITANE_INGOT.get()).copy();
		...
		if (hasEntityInInventory(entity, new ItemStack(PalamodModItems.COBBLEBREAKER_AMETHYST_UPGRADE.get()))
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack47 = new ItemStack(PalamodModItems.COBBLEBREAKER_AMETHYST_UPGRADE.get()).copy();
		...
		if (hasEntityInInventory(entity, new ItemStack(PalamodModItems.TITANE_INGOT.get()))
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack55 = new ItemStack(PalamodModItems.TITANE_INGOT.get()).copy();
