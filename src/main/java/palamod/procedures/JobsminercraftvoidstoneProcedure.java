...
public class JobsminercraftvoidstoneProcedure {
	public static void execute(Entity entity) {
			...
			return;
		{
			...
			_vars.lvl_required = "Lvl required : 2";
			_vars.markSyncDirty();
		}
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			...
			ItemStack _setstack4 = new ItemStack(Blocks.CHEST).copy();
			_setstack4.setCount(1);
			_menu.getSlots().get(4).set(_setstack4);
			ItemStack _setstack5 = new ItemStack(PalamodModItems.VOIDSTONE.get()).copy();
