...
public class BackpackloaditemProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (backpack.exists()) {
			if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).is(ItemTags.create(Identifier.parse("palamod:backpack")))) {
						...
						try {
							...
							for (int index0 = 0; index0 < 9; index0++) {
								if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
									ItemStack _setstack27 = new ItemStack(BuiltInRegistries.ITEM.getValue(Identifier.parse((main.get(("backpack_inv_" + i)).getAsString()).toLowerCase(java.util.Locale.ENGLISH)))).copy();
				...
				if (i2 >= 27) {
					{
						try {
							...
							for (int index1 = 0; index1 < 18; index1++) {
								if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
									ItemStack _setstack33 = new ItemStack(BuiltInRegistries.ITEM.getValue(Identifier.parse((main_backpack_titane.get(("backpack_inv_" + i)).getAsString()).toLowerCase(java.util.Locale.ENGLISH)))).copy();
				...
				if (i2 >= 54) {
					{
						try {
							...
							for (int index2 = 0; index2 < 27; index2++) {
								if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
									ItemStack _setstack39 = new ItemStack(BuiltInRegistries.ITEM.getValue(Identifier.parse((main_backpack_paladium.get(("backpack_inv_" + i)).getAsString()).toLowerCase(java.util.Locale.ENGLISH)))).copy();
				...
				if (i2 >= 81) {
					{
						try {
							...
							for (int index3 = 0; index3 < 27; index3++) {
								if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
									ItemStack _setstack45 = new ItemStack(BuiltInRegistries.ITEM.getValue(Identifier.parse((main_backpack_endium.get(("backpack_inv_" + i)).getAsString()).toLowerCase(java.util.Locale.ENGLISH)))).copy();
