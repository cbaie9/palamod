...
public class JobsminercraftamethystexcavatorProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			ItemStack _setstack0 = new ItemStack(PalamodModItems.AMETHYST_SHOVEL.get()).copy();
			_setstack0.setCount(1);
			_menu.getSlots().get(0).set(_setstack0);
			ItemStack _setstack1 = new ItemStack(PalamodModItems.AMETHYST_SHOVEL.get()).copy();
			...
			ItemStack _setstack4 = new ItemStack(PalamodModItems.AMETHYST_SHOVEL.get()).copy();
			_setstack4.setCount(1);
			_menu.getSlots().get(2).set(_setstack4);
			ItemStack _setstack5 = new ItemStack(PalamodModItems.AMETHYST_EXCAVATOR.get()).copy();
