...
public class FillSlotPalahelpXpGainProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		output = GetItemPalahelpJobsXpgainProcedure.execute(world, entity, 0).copy();
		...
		output = GetItemPalahelpJobsXpgainProcedure.execute(world, entity, 1).copy();
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
		...
		output = GetItemPalahelpJobsXpgainProcedure.execute(world, entity, 2).copy();
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
		...
		output = GetItemPalahelpJobsXpgainProcedure.execute(world, entity, 3).copy();
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
		...
		output = GetItemPalahelpJobsXpgainProcedure.execute(world, entity, 4).copy();
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
		...
		output = GetItemPalahelpJobsXpgainProcedure.execute(world, entity, 5).copy();
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
