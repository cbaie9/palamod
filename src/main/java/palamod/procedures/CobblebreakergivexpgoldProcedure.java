...
public class CobblebreakergivexpgoldProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity instanceof Player _player)
			_player.giveExperiencePoints(itemFromBlockInventory(world, BlockPos.containing(x, y, z), 2).getCount());
					...
					try {
						...
						if (25 <= lvl) {
							...
							if (entity instanceof ServerPlayer _player)
								_player.sendSystemMessage(Component.literal((Component.translatable("palamod.procedure.jobswin1").getString() + "" + (4 * main.get("multi_exp").getAsDouble() + main.get("xpstreak_miner").getAsDouble())
