...
public class JobsminercraftwithertntProcedure {
	public static void execute(Entity entity) {
		...
		if (hasEntityInInventory(entity, new ItemStack(Items.WITHER_SKELETON_SKULL)) && (getAmountInGUISlot(entity, 1) == 0
				|| (entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof PalamodModMenus.MenuAccessor _menu10 ? _menu10.getSlots().get(1).getItem() : ItemStack.EMPTY).getItem() == Items.WITHER_SKELETON_SKULL
		...
		if (hasEntityInInventory(entity, new ItemStack(Items.WITHER_SKELETON_SKULL)) && (getAmountInGUISlot(entity, 2) == 0
				|| (entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof PalamodModMenus.MenuAccessor _menu18 ? _menu18.getSlots().get(2).getItem() : ItemStack.EMPTY).getItem() == Items.WITHER_SKELETON_SKULL
		...
		if (hasEntityInInventory(entity, new ItemStack(Blocks.TNT)) && (getAmountInGUISlot(entity, 3) == 0
				|| (entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof PalamodModMenus.MenuAccessor _menu50 ? _menu50.getSlots().get(3).getItem() : ItemStack.EMPTY).getItem() == Blocks.TNT.asItem()
		...
		if (hasEntityInInventory(entity, new ItemStack(Blocks.TNT)) && (getAmountInGUISlot(entity, 5) == 0
				|| (entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof PalamodModMenus.MenuAccessor _menu66 ? _menu66.getSlots().get(5).getItem() : ItemStack.EMPTY).getItem() == Blocks.TNT.asItem()
