...
public class JobsminercraftwithertntProcedure {
	public static void execute(Entity entity) {
		...
		if ((entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Items.WITHER_SKELETON_SKULL)) : false) && (getAmountInGUISlot(entity, 0) == 0
		...
		if ((entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Items.WITHER_SKELETON_SKULL)) : false) && (getAmountInGUISlot(entity, 1) == 0
		...
		if ((entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Items.WITHER_SKELETON_SKULL)) : false) && (getAmountInGUISlot(entity, 2) == 0
