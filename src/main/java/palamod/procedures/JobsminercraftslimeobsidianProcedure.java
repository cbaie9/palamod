...
public class JobsminercraftslimeobsidianProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			...
			ItemStack _setstack4 = new ItemStack(Blocks.OBSIDIAN).copy();
			...
			ItemStack _setstack6 = new ItemStack(PalamodModBlocks.SLIMEPAD.get()).copy();
			_setstack6.setCount(1);
			_menu.getSlots().get(3).set(_setstack6);
			ItemStack _setstack7 = new ItemStack(PalamodModBlocks.SLIMEPAD.get()).copy();
			_setstack7.setCount(1);
			_menu.getSlots().get(4).set(_setstack7);
			ItemStack _setstack8 = new ItemStack(PalamodModBlocks.SLIMEPAD.get()).copy();
			_setstack8.setCount(1);
			_menu.getSlots().get(5).set(_setstack8);
			ItemStack _setstack9 = new ItemStack(PalamodModBlocks.SLIME_OBSIDIAN.get()).copy();
