...
public class PalahelpstickmodejumpProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			ItemStack _setstack0 = new ItemStack(PalamodModItems.TITANE_STICK.get()).copy();
			...
			ItemStack _setstack2 = new ItemStack(PalamodModItems.TITANE_STICK.get()).copy();
			_setstack2.setCount(1);
			_menu.getSlots().get(2).set(_setstack2);
			ItemStack _setstack3 = new ItemStack(PalamodModBlocks.SLIMEPAD.get()).copy();
			_setstack3.setCount(1);
			_menu.getSlots().get(3).set(_setstack3);
			ItemStack _setstack4 = new ItemStack(PalamodModBlocks.SLIMEPAD.get()).copy();
			...
			ItemStack _setstack10 = new ItemStack(Items.NETHER_WART).copy();
			_setstack10.setCount(1);
			_menu.getSlots().get(10).set(_setstack10);
			ItemStack _setstack11 = new ItemStack(PalamodModItems.JUMP_ORB.get()).copy();
			_setstack11.setCount(1);
			_menu.getSlots().get(15).set(_setstack11);
			_player.containerMenu.broadcastChanges();
		}
		entity.getPersistentData().putDouble("mode_stick", 2);
	}
}