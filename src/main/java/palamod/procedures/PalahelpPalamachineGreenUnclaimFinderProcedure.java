...
public class PalahelpPalamachineGreenUnclaimFinderProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			...
			_menu.getSlots().get(13).set(_setstack1);
			...
			_menu.getSlots().get(9).set(_setstack3);
		...
		entity.getPersistentData().putDouble("mode_palamachine_craft", 18);
	}
}