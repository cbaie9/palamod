...
public class BackpackdropdeathnolockProcedure {
	public static void execute(LevelAccessor world, Entity entity, double slot_num) {
		...
		if (backpack.exists()) {
			...
			i = 0;
			if (i2 >= 0) {
				for (int index508 = 0; index508 < 9; index508++) {
			...
			if (i2 >= 9) {
				for (int index509 = 0; index509 < 18; index509++) {
					if (entity instanceof Player _player) {
			...
			if (i2 >= 27) {
				for (int index510 = 0; index510 < 18; index510++) {
					if (entity instanceof Player _player) {
			...
			if (i2 >= 55) {
				for (int index511 = 0; index511 < 18; index511++) {
					i = i + 1;
					if (entity instanceof Player _player) {
