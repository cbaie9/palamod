...
public class BackpackdropdeathnolockProcedure {
	public static void execute(LevelAccessor world, Entity entity, double slot_num) {
		...
		if (backpack.exists()) {
			...
			i = 0;
			if (i2 >= 0) {
				for (int index189 = 0; index189 < 9; index189++) {
			...
			if (i2 >= 9) {
				for (int index190 = 0; index190 < 18; index190++) {
					if (entity instanceof Player _player) {
			...
			if (i2 >= 27) {
				for (int index191 = 0; index191 < 18; index191++) {
					if (entity instanceof Player _player) {
			...
			if (i2 >= 55) {
				for (int index192 = 0; index192 < 18; index192++) {
					i = i + 1;
					if (entity instanceof Player _player) {
