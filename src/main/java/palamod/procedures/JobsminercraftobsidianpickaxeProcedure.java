...
public class JobsminercraftobsidianpickaxeProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			...
			ItemStack _setstack1 = new ItemStack(PalamodModBlocks.PALADIUM_SPIKE.get()).copy();
			_setstack1.setCount(1);
			_menu.getSlots().get(0).set(_setstack1);
			ItemStack _setstack2 = new ItemStack(PalamodModBlocks.PALADIUM_SPIKE.get()).copy();
			...
			ItemStack _setstack5 = new ItemStack(PalamodModItems.OBSIDIAN_PICKAXE.get()).copy();
