...
public class JobsminercraftfakewaterobsidianProcedure {
	public static void execute(Entity entity) {
		...
		if ((entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(PalamodModItems.FAKE_WATER_BUCKET.get())) : false) && getAmountInGUISlot(entity, 0) == 0) {
