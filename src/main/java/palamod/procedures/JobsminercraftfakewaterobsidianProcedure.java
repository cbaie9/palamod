...
public class JobsminercraftfakewaterobsidianProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			ItemStack _setstack0 = new ItemStack(PalamodModItems.FAKE_WATER_BUCKET.get()).copy();
			...
			ItemStack _setstack2 = new ItemStack(PalamodModBlocks.FAKE_WATER_OBSIDIAN.get()).copy();
