...
public class PalahelpPalamachineGreenPaladiumringmediumProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		ItemStack damaged_item = ItemStack.EMPTY;
		if (8 == entity.getPersistentData().getDouble("mode_palamachine_craft")) {
			damaged_item = new ItemStack(PalamodModItems.GREEN_PALADIUM_MEDIUM_RING.get()).copy();
			if (world instanceof ServerLevel _level) {
				damaged_item.hurtAndBreak(50, _level, null, _stkprov -> {
				});
			}
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack2 = new ItemStack(PalamodModItems.GREEN_PALADIUM_INGOT.get()).copy();
				_setstack2.setCount(1);
				_menu.getSlots().get(0).set(_setstack2);
				ItemStack _setstack3 = new ItemStack(PalamodModItems.GREEN_PALADIUM_PARTICLE.get()).copy();
				_setstack3.setCount(1);
				_menu.getSlots().get(1).set(_setstack3);
				ItemStack _setstack4 = damaged_item.copy();
				_setstack4.setCount(1);
				_menu.getSlots().get(2).set(_setstack4);
				ItemStack _setstack5 = new ItemStack(PalamodModItems.GREEN_PALADIUM_PARTICLE.get()).copy();
				...
				ItemStack _setstack7 = new ItemStack(PalamodModItems.GREEN_PALADIUM_MEDIUM_RING.get()).copy();
			...
			entity.getPersistentData().putDouble("mode_palamachine_craft", 9);
		} else {
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack18 = new ItemStack(PalamodModBlocks.PALADIUM_GREEN_BLOCK.get()).copy();
				...
				ItemStack _setstack20 = new ItemStack(PalamodModItems.GREEN_PALADIUM_SMALL_RING.get()).copy();
				_setstack20.setCount(1);
				_menu.getSlots().get(2).set(_setstack20);
				ItemStack _setstack21 = new ItemStack(PalamodModBlocks.PALADIUM_GREEN_BLOCK.get()).copy();
				_setstack21.setCount(1);
				_menu.getSlots().get(3).set(_setstack21);
				ItemStack _setstack22 = new ItemStack(PalamodModItems.GREEN_PALADIUM_INGOT.get()).copy();
				_setstack22.setCount(1);
				_menu.getSlots().get(4).set(_setstack22);
				ItemStack _setstack23 = new ItemStack(PalamodModItems.GREEN_PALADIUM_MEDIUM_RING.get()).copy();
			...
			entity.getPersistentData().putDouble("mode_palamachine_craft", 8);
		}
	}
}