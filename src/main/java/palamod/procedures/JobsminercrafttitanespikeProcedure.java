...
public class JobsminercrafttitanespikeProcedure {
	public static void execute(Entity entity) {
		...
		if (hasEntityInInventory(entity, new ItemStack(PalamodModBlocks.TITANE_SPIKE.get())) && (getAmountInGUISlot(entity, 1) == 0
				|| (entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof PalamodModMenus.MenuAccessor _menu10 ? _menu10.getSlots().get(1).getItem() : ItemStack.EMPTY).getItem() == PalamodModBlocks.TITANE_SPIKE.get().asItem()
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack15 = new ItemStack(PalamodModBlocks.TITANE_SPIKE.get()).copy();
