...
public class JobsminercraftdiamondspikeProcedure {
	public static void execute(Entity entity) {
		...
		if (hasEntityInInventory(entity, new ItemStack(PalamodModBlocks.DIAMOND_SPIKE.get()))
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack15 = new ItemStack(PalamodModBlocks.DIAMOND_SPIKE.get()).copy();
