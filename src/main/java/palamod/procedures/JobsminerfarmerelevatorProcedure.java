...
public class JobsminerfarmerelevatorProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			ItemStack _setstack0 = new ItemStack(Blocks.WHITE_WOOL).copy();
			_setstack0.setCount(1);
			_menu.getSlots().get(0).set(_setstack0);
			ItemStack _setstack1 = new ItemStack(Blocks.WHITE_WOOL).copy();
			_setstack1.setCount(1);
			_menu.getSlots().get(2).set(_setstack1);
			ItemStack _setstack2 = new ItemStack(Blocks.WHITE_WOOL).copy();
			_setstack2.setCount(1);
			_menu.getSlots().get(2).set(_setstack2);
			ItemStack _setstack3 = new ItemStack(PalamodModItems.FURNACE_UPGRADE.get()).copy();
			_setstack3.setCount(1);
			_menu.getSlots().get(3).set(_setstack3);
			ItemStack _setstack4 = new ItemStack(Blocks.PISTON).copy();
			_setstack4.setCount(1);
			_menu.getSlots().get(4).set(_setstack4);
			ItemStack _setstack5 = new ItemStack(PalamodModItems.FURNACE_UPGRADE.get()).copy();
			_setstack5.setCount(1);
			_menu.getSlots().get(5).set(_setstack5);
			ItemStack _setstack6 = new ItemStack(Blocks.OAK_PLANKS).copy();
			_setstack6.setCount(1);
			_menu.getSlots().get(6).set(_setstack6);
			ItemStack _setstack7 = new ItemStack(Items.REDSTONE).copy();
			_setstack7.setCount(1);
			_menu.getSlots().get(7).set(_setstack7);
			ItemStack _setstack8 = new ItemStack(Blocks.OAK_PLANKS).copy();
			_setstack8.setCount(1);
			_menu.getSlots().get(8).set(_setstack8);
			ItemStack _setstack9 = new ItemStack(PalamodModBlocks.ELEVATOR_WHITE.get()).copy();
