...
public class PalahelpPalamachinePaladiumringmediumProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		ItemStack damaged_item = ItemStack.EMPTY;
		if (2 == entity.getPersistentData().getDouble("mode_palamachine_craft")) {
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack2 = new ItemStack(PalamodModItems.PALADIUM_PARTICLE.get()).copy();
				...
				ItemStack _setstack5 = new ItemStack(PalamodModItems.PALADIUM_PARTICLE.get()).copy();
				_setstack5.setCount(1);
				_menu.getSlots().get(3).set(_setstack5);
				ItemStack _setstack6 = new ItemStack(PalamodModBlocks.PALADIUM_BLOCK.get()).copy();
				_setstack6.setCount(1);
				_menu.getSlots().get(4).set(_setstack6);
				ItemStack _setstack7 = new ItemStack(PalamodModItems.MEDIUM_RING.get()).copy();
			...
			entity.getPersistentData().putDouble("mode_palamachine_craft", 3);
		} else {
			if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
				ItemStack _setstack18 = new ItemStack(PalamodModBlocks.PALADIUM_BLOCK.get()).copy();
				...
				ItemStack _setstack21 = new ItemStack(PalamodModBlocks.PALADIUM_BLOCK.get()).copy();
				...
				ItemStack _setstack23 = new ItemStack(PalamodModItems.MEDIUM_RING.get()).copy();
			...
			entity.getPersistentData().putDouble("mode_palamachine_craft", 2);
		}
	}
}