...
public class CobblebreakergivexptitaneProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity instanceof Player _player)
			_player.giveExperiencePoints(itemFromBlockInventory(world, BlockPos.containing(x, y, z), 5).getCount());
					...
					try {
						...
						if (25 <= lvl) {
							...
							if (entity instanceof ServerPlayer _player)
								_player.sendSystemMessage(Component.literal((Component.translatable("palamod.procedure.jobswin1").getString() + "" + (16 * main.get("multi_exp").getAsDouble() + main.get("xpstreak_miner").getAsDouble())
