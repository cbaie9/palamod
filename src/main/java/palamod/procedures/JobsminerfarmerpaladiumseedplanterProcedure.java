...
public class JobsminerfarmerpaladiumseedplanterProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			...
			ItemStack _setstack1 = new ItemStack(PalamodModItems.COMPRESSED_PALADIUM.get()).copy();
			...
			ItemStack _setstack4 = new ItemStack(PalamodModItems.TITANE_SEEDPLANTER.get()).copy();
			...
			ItemStack _setstack9 = new ItemStack(PalamodModItems.PALADIUM_SEEDPLANTER.get()).copy();
