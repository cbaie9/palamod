		...
		if (world instanceof ServerLevel _level)
			_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
					("tellraw @p [\"\",{\"text\":\"[ Palamod ] :\",\"color\":\"dark_red\"},{\"text\":\"\\n\"},{\"text\":\"---------------------------------------\",\"color\":\"dark_green\"},{\"text\":\"\\n\"},{\"text\":\"Faction \",\"color\":\"aqua\"},{\"text\":\""
							...
							+ Math.round(getBlockNBTNumber(world, new BlockPos(0, 9, 0), ("Faction_nb-m_" + get_id)))
							...
							+ Math.round(getBlockNBTNumber(world, new BlockPos(0, 9, 0), ("Faction_power_" + get_id)))
							...
							+ Math.round(getBlockNBTNumber(world, new BlockPos(0, 9, 0), ("Faction_invite_" + get_id)))
