...
public class JobsminercraftamethystspikeProcedure {
	public static void execute(Entity entity) {
		...
		if ((entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(PalamodModBlocks.AMETHYST_SPIKE.get())) : false)
				&& (getAmountInGUISlot(entity, 1) == 0 || (entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(1)).getItem() : ItemStack.EMPTY)
						.getItem() == PalamodModBlocks.AMETHYST_SPIKE.get().asItem() || getAmountInGUISlot(entity, 1) < 64)) {
			if (entity instanceof Player _player) {
