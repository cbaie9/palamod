...
public class JobsminercraftcaveblockProcedure {
	public static void execute(Entity entity) {
			...
			return;
		{
			...
			_vars.lvl_required = "Lvl required : None";
			_vars.markSyncDirty();
		}
		CraftdoneminerProcedure.execute(entity);
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			ItemStack _setstack0 = new ItemStack(Blocks.GLASS).copy();
			_setstack0.setCount(1);
			_menu.getSlots().get(0).set(_setstack0);
			ItemStack _setstack1 = new ItemStack(Blocks.GLASS).copy();
			_setstack1.setCount(1);
			_menu.getSlots().get(1).set(_setstack1);
			ItemStack _setstack2 = new ItemStack(Blocks.GLASS).copy();
			_setstack2.setCount(1);
			_menu.getSlots().get(2).set(_setstack2);
			ItemStack _setstack3 = new ItemStack(Blocks.GLASS).copy();
			...
			ItemStack _setstack5 = new ItemStack(Blocks.GLASS).copy();
			_setstack5.setCount(1);
			_menu.getSlots().get(5).set(_setstack5);
			ItemStack _setstack6 = new ItemStack(Blocks.GLASS).copy();
			...
			ItemStack _setstack8 = new ItemStack(Blocks.GLASS).copy();
			_setstack8.setCount(1);
			_menu.getSlots().get(8).set(_setstack8);
			ItemStack _setstack9 = new ItemStack(PalamodModBlocks.CAVE_BLOCK.get()).copy();
