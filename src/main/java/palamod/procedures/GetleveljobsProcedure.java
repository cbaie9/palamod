...
public class GetleveljobsProcedure {
	public static double execute(LevelAccessor world, Entity entity, String jobs_name) {
		...
		} else {/*failsafe when jobs are disable | used in cauldron to get levels to craft glueball*/
			lvl = 99999;
		}
		return lvl;
	}
