...
public class JobsminercraftmoulastoneProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			ItemStack _setstack0 = new ItemStack(Items.ENDER_PEARL).copy();
			_setstack0.setCount(1);
			_menu.getSlots().get(0).set(_setstack0);
			ItemStack _setstack1 = new ItemStack(Items.ENDER_PEARL).copy();
			...
			ItemStack _setstack3 = new ItemStack(Items.ENDER_PEARL).copy();
			_setstack3.setCount(1);
			_menu.getSlots().get(6).set(_setstack3);
			ItemStack _setstack4 = new ItemStack(PalamodModItems.AMETHYST_INGOT.get()).copy();
			_setstack4.setCount(1);
			_menu.getSlots().get(7).set(_setstack4);
			ItemStack _setstack5 = new ItemStack(Items.ENDER_PEARL).copy();
			...
			ItemStack _setstack7 = new ItemStack(PalamodModItems.DOLLARS_STONE.get()).copy();
			_setstack7.setCount(1);
			_menu.getSlots().get(9).set(_setstack7);
