...
public class PalahelpstickmodestrenghtProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			...
			ItemStack _setstack1 = new ItemStack(PalamodModItems.STRENGH_ORB.get()).copy();
			...
			ItemStack _setstack10 = new ItemStack(Items.BLAZE_POWDER).copy();
			_setstack10.setCount(1);
			_menu.getSlots().get(10).set(_setstack10);
			ItemStack _setstack11 = new ItemStack(PalamodModItems.STRENGH_ORB.get()).copy();
			_setstack11.setCount(1);
			_menu.getSlots().get(15).set(_setstack11);
			_player.containerMenu.broadcastChanges();
		}
		entity.getPersistentData().putDouble("mode_stick", 6);
	}
}