...
public class PhonecodeProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (!(entity instanceof ServerPlayer _plr0 && _plr0.level() instanceof ServerLevel _serverLevel0
				&& _plr0.getAdvancements().getOrStartProgress(_serverLevel0.getServer().getAdvancements().get(Identifier.parse("palamod:achmluckyphone"))).isDone())) {
			if (entity instanceof ServerPlayer _player && _player.level() instanceof ServerLevel _level) {
				AdvancementHolder _adv = _level.getServer().getAdvancements().get(Identifier.parse("palamod:achmluckyphone"));
				if (_adv != null) {
		...
		if (((entity instanceof Player _entity2 && _entity2.containerMenu instanceof PalamodModMenus.MenuAccessor _menu2) ? _menu2.getMenuState(0, "cheat_code_secret", "") : "").contains("cbaie9")
			...
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("msg @s an cheater has been detected"), false);
			if (entity instanceof Player _player)
				_player.closeContainer();
			...
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("reset.gamemode has been succesful executed You now in gamemode survival"), false);
			if (entity instanceof Player _player)
				_player.closeContainer();
			...
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("Claud fran\u00E7ois vibes"), false);
			if (entity instanceof Player _player)
				_player.closeContainer();
			...
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("msg @p Jojo veut la mort de quelqu'un ici"), false);
			...
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("Rejoins le serveur communautaire https://discord.gg/3J772jpRt2"), false);
			...
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("Voila un chapeau Monsieur"), false);
			...
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("Eh ben maintenant tu peux aller miner des chose et se sera positif"), false);
			...
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("Paladium system program"), false);
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("dir : M:/"), false);
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("Textures"), false);
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("Crafts"), false);
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("Codeultracheats2235.txt"), false);
			...
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("Paladium system program"), false);
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("dir : M:/Codeultracheats2235.txt"), false);
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("text file : Le code du cheats est "), false);
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("0259.cf42214"), false);
			...
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("Cheats Activated"), false);
			if (entity instanceof Player _player) {
			...
			if (Math.random() < 0.5) {
				if (entity instanceof ServerPlayer _player)
					_player.sendSystemMessage(Component.literal("a l'huile"), false);
			} else {
				if (entity instanceof ServerPlayer _player)
					_player.sendSystemMessage(Component.literal("a hopital"), false);
			}
			...
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("1.0 vibes"), false);
			if (entity instanceof Player _player) {
			...
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("Merci de soutenir le mod"), false);
			if (entity instanceof Player _player) {
				ItemStack _setstack = (entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).copy();
			...
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("Miaou.....Ronron~"), false);
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("Oh tiens un chat"), false);
			...
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("Rejoins le serveur de la PunkAstik https://discord.gg[censored bc fdp]"), false);
			if (entity instanceof ServerPlayer _player)
				_player.sendSystemMessage(Component.literal("( c'est plus ma fac )"), false);
		}
	}
}