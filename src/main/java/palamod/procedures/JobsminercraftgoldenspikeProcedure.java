...
public class JobsminercraftgoldenspikeProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player && _player.containerMenu instanceof PalamodModMenus.MenuAccessor _menu) {
			...
			ItemStack _setstack1 = new ItemStack(PalamodModBlocks.SPIKE_GOLD.get()).copy();
			_setstack1.setCount(1);
			_menu.getSlots().get(1).set(_setstack1);
			ItemStack _setstack2 = new ItemStack(PalamodModBlocks.GOLDEN_OBSIDIAN_SPIKE.get()).copy();
