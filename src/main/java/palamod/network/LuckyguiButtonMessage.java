...
public class LuckyguiButtonMessage {
	...
	public LuckyguiButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(LuckyguiButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(LuckyguiButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
