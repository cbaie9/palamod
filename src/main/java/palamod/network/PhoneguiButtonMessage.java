...
public record PhoneguiButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	public static final Type<PhoneguiButtonMessage> TYPE = new Type<>(Identifier.fromNamespaceAndPath(PalamodMod.MODID, "phonegui_buttons"));
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			PhonecodeProcedure.execute(world, x, y, z, entity);
		}
	}
