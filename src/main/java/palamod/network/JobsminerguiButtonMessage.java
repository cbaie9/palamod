...
public class JobsminerguiButtonMessage {
	...
	public JobsminerguiButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JobsminerguiButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JobsminerguiButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
