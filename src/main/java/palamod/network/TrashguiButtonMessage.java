...
public class TrashguiButtonMessage {
	...
	public TrashguiButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(TrashguiButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(TrashguiButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
