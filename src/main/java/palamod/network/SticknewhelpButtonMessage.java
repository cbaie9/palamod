...
public class SticknewhelpButtonMessage {
	private final int buttonID, x, y, z;

	public SticknewhelpButtonMessage(FriendlyByteBuf buffer) {
	...
	public SticknewhelpButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(SticknewhelpButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(SticknewhelpButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(SticknewhelpButtonMessage.class, SticknewhelpButtonMessage::buffer, SticknewhelpButtonMessage::new, SticknewhelpButtonMessage::handler);
	}
}
