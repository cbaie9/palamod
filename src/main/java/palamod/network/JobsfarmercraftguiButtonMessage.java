...
public class JobsfarmercraftguiButtonMessage {
	private final int buttonID, x, y, z;

	public JobsfarmercraftguiButtonMessage(FriendlyByteBuf buffer) {
	...
	public JobsfarmercraftguiButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(JobsfarmercraftguiButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(JobsfarmercraftguiButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PalamodMod.addNetworkMessage(JobsfarmercraftguiButtonMessage.class, JobsfarmercraftguiButtonMessage::buffer, JobsfarmercraftguiButtonMessage::new, JobsfarmercraftguiButtonMessage::handler);
	}
}
