...
public class CrusherguiSlotMessage {
	...
	public CrusherguiSlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(CrusherguiSlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(CrusherguiSlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
