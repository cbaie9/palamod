...
public record DownloaderguiButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	public static final Type<DownloaderguiButtonMessage> TYPE = new Type<>(Identifier.fromNamespaceAndPath(PalamodMod.MODID, "downloadergui_buttons"));
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			DownloaderreloadProcedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 1) {
