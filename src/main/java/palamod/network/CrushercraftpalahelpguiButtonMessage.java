...
public record CrushercraftpalahelpguiButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	public static final Type<CrushercraftpalahelpguiButtonMessage> TYPE = new Type<>(Identifier.fromNamespaceAndPath(PalamodMod.MODID, "crushercraftpalahelpgui_buttons"));
