...
public class PalamodModScreens {
	...
	public static void clientLoad(RegisterMenuScreensEvent event) {
		...
		event.register(PalamodModMenus.NEXT_PALAHELPGUI.get(), NextPalahelpguiScreen::new);
		...
		event.register(PalamodModMenus.EXAMPLECRUSHERV_2.get(), Examplecrusherv2Screen::new);
