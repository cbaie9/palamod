...
public class PalamodModPotions {
	...
	public static final RegistryObject<Potion> POTION_MINEUR_FOU = REGISTRY.register("potion_mineur_fou", () -> new Potion(new MobEffectInstance(PalamodModMobEffects.MINEUR_FOU.get(), 72000, 0, false, true)));
}
