...
public class PalamodModMenus {
	...
	public static final DeferredHolder<MenuType<?>, MenuType<NextPalahelpguiMenu>> NEXT_PALAHELPGUI = REGISTRY.register("next_palahelpgui", () -> IMenuTypeExtension.create(NextPalahelpguiMenu::new));
	...
	public static final DeferredHolder<MenuType<?>, MenuType<Examplecrusherv2Menu>> EXAMPLECRUSHERV_2 = REGISTRY.register("examplecrusherv_2", () -> IMenuTypeExtension.create(Examplecrusherv2Menu::new));
