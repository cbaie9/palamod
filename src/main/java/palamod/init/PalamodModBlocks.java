...
public class PalamodModBlocks {
	...
	public static final DeferredBlock<Block> HARDENEDOBSIDIANSLAB = REGISTRY.register("hardenedobsidianslab", HardenedobsidianslabBlock::new);
	public static final DeferredBlock<Block> FAKEWTER = REGISTRY.register("fakewter", FakewterBlock::new);
	public static final DeferredBlock<Block> ANGELICWTER = REGISTRY.register("angelicwter", AngelicwterBlock::new);
	public static final DeferredBlock<Block> SLIMEOBSIDIAN = REGISTRY.register("slimeobsidian", SlimeobsidianBlock::new);
	public static final DeferredBlock<Block> POISONOBSIDIAN = REGISTRY.register("poisonobsidian", PoisonobsidianBlock::new);
	public static final DeferredBlock<Block> EXCTRACTOR = REGISTRY.register("exctractor", ExctractorBlock::new);
	public static final DeferredBlock<Block> BOOMOBSIDIAN = REGISTRY.register("boomobsidian", BoomobsidianBlock::new);
	...
	public static final DeferredBlock<Block> REDGLUEBALL = REGISTRY.register("redglueball", RedglueballBlock::new);
	public static final DeferredBlock<Block> GREENGLUEBALL = REGISTRY.register("greenglueball", GreenglueballBlock::new);
	public static final DeferredBlock<Block> LIGHTGREENGLUEBALL = REGISTRY.register("lightgreenglueball", LightgreenglueballBlock::new);
	public static final DeferredBlock<Block> DARKGREENGLUEBALL = REGISTRY.register("darkgreenglueball", DarkgreenglueballBlock::new);
	public static final DeferredBlock<Block> BLUEGLUEBALL = REGISTRY.register("blueglueball", BlueglueballBlock::new);
	public static final DeferredBlock<Block> PURPLEGLUEBALL = REGISTRY.register("purpleglueball", PurpleglueballBlock::new);
	public static final DeferredBlock<Block> YELLOWGLUEBALL = REGISTRY.register("yellowglueball", YellowglueballBlock::new);
