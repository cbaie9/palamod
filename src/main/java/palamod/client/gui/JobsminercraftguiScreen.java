...
public class JobsminercraftguiScreen extends AbstractContainerScreen<JobsminercraftguiMenu> implements PalamodModScreens.ScreenAccessor {
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		guiGraphics.text(this.font, Component.translatable("gui.palamod.jobsminercraftgui.label_jobs_miner_crafts"), 106, 7, -1, false);
		guiGraphics.text(this.font, Component.translatable("gui.palamod.jobsminercraftgui.label_information"), 174, 115, -1, false);
	...
	public void init() {
		...
		imagebutton_endium_pickaxe = new ImageButton(this.leftPos + 10, this.topPos + 29, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/endium_pickaxe.png"), Identifier.parse("palamod:textures/screens/endium_pickaxe_white.png")), e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_potg_of_1 = new ImageButton(this.leftPos + 30, this.topPos + 28, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/potg_of_1.png"), Identifier.parse("palamod:textures/screens/potg_of_white.png")), e -> {
		}) {
			@Override
			public void extractContents(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
				guiGraphics.blit(RenderPipelines.GUI_TEXTURED, sprites.get(isActive(), isHoveredOrFocused()), getX(), getY(), 0, 0, width, height, width, height);
		...
		imagebutton_amethyste_exca = new ImageButton(this.leftPos + 48, this.topPos + 29, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/amethyste_exca.png"), Identifier.parse("palamod:textures/screens/amethyst_excavator_white.png")), e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_titane_excavator = new ImageButton(this.leftPos + 67, this.topPos + 29, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/titane_excavator.png"), Identifier.parse("palamod:textures/screens/titane_excavator_white.png")), e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_paladium_excavator = new ImageButton(this.leftPos + 86, this.topPos + 29, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/paladium_excavator.png"), Identifier.parse("palamod:textures/screens/paladium_excavator_white.png")), e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_magical_tool16 = new ImageButton(this.leftPos + 105, this.topPos + 29, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/magical_tool16.png"), Identifier.parse("palamod:textures/screens/magical_tool16_white.png")), e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_voidstone = new ImageButton(this.leftPos + 124, this.topPos + 29, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/voidstone.png"), Identifier.parse("palamod:textures/screens/voidstone_white.png")), e -> {
			int x = JobsminercraftguiScreen.this.x;
			int y = JobsminercraftguiScreen.this.y;
			if (true) {
		...
		imagebutton_obsidian_pickaxe = new ImageButton(this.leftPos + 143, this.topPos + 29, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/obsidian_pickaxe.png"), Identifier.parse("palamod:textures/screens/obsidian_pickaxe_white.png")), e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_boom_obsi = new ImageButton(this.leftPos + 162, this.topPos + 29, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/boom_obsi.png"), Identifier.parse("palamod:textures/screens/block_white.png")), e -> {
			int x = JobsminercraftguiScreen.this.x;
			int y = JobsminercraftguiScreen.this.y;
			if (true) {
		...
		imagebutton_big_obsi = new ImageButton(this.leftPos + 10, this.topPos + 48, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/big_obsi.png"), Identifier.parse("palamod:textures/screens/block_white.png")), e -> {
			int x = JobsminercraftguiScreen.this.x;
			int y = JobsminercraftguiScreen.this.y;
			if (true) {
		...
		imagebutton_spike_obsi = new ImageButton(this.leftPos + 48, this.topPos + 48, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/spike_obsi.png"), Identifier.parse("palamod:textures/screens/block_white.png")), e -> {
			int x = JobsminercraftguiScreen.this.x;
			int y = JobsminercraftguiScreen.this.y;
			if (true) {
		...
		imagebutton_spike_obsi_1 = new ImageButton(this.leftPos + 67, this.topPos + 48, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/spike_obsi_1.png"), Identifier.parse("palamod:textures/screens/block_white.png")), e -> {
			int x = JobsminercraftguiScreen.this.x;
			int y = JobsminercraftguiScreen.this.y;
			if (true) {
		...
		imagebutton_spike_obsi_2 = new ImageButton(this.leftPos + 86, this.topPos + 48, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/spike_obsi_2.png"), Identifier.parse("palamod:textures/screens/block_white.png")), e -> {
			int x = JobsminercraftguiScreen.this.x;
			int y = JobsminercraftguiScreen.this.y;
			if (true) {
		...
		imagebutton_spike_obsi_3 = new ImageButton(this.leftPos + 105, this.topPos + 48, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/spike_obsi_3.png"), Identifier.parse("palamod:textures/screens/block_white.png")), e -> {
			int x = JobsminercraftguiScreen.this.x;
			int y = JobsminercraftguiScreen.this.y;
			if (true) {
		...
		imagebutton_spike_obsi_4 = new ImageButton(this.leftPos + 124, this.topPos + 48, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/spike_obsi_4.png"), Identifier.parse("palamod:textures/screens/block_white.png")), e -> {
			int x = JobsminercraftguiScreen.this.x;
			int y = JobsminercraftguiScreen.this.y;
			if (true) {
		...
		imagebutton_spike_obsi_5 = new ImageButton(this.leftPos + 143, this.topPos + 48, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/spike_obsi_5.png"), Identifier.parse("palamod:textures/screens/block_white.png")), e -> {
			int x = JobsminercraftguiScreen.this.x;
			int y = JobsminercraftguiScreen.this.y;
			if (true) {
		...
		imagebutton_spike_obsi_6 = new ImageButton(this.leftPos + 162, this.topPos + 48, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/spike_obsi_6.png"), Identifier.parse("palamod:textures/screens/block_white.png")), e -> {
			int x = JobsminercraftguiScreen.this.x;
			int y = JobsminercraftguiScreen.this.y;
			if (true) {
		...
		imagebutton_lava_obsi = new ImageButton(this.leftPos + 10, this.topPos + 67, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/lava_obsi.png"), Identifier.parse("palamod:textures/screens/block_white.png")), e -> {
			int x = JobsminercraftguiScreen.this.x;
			int y = JobsminercraftguiScreen.this.y;
			if (true) {
		...
		imagebutton_fake_obsi = new ImageButton(this.leftPos + 29, this.topPos + 67, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/fake_obsi.png"), Identifier.parse("palamod:textures/screens/block_white.png")), e -> {
			int x = JobsminercraftguiScreen.this.x;
			int y = JobsminercraftguiScreen.this.y;
			if (true) {
		...
		imagebutton_slime_obsi = new ImageButton(this.leftPos + 48, this.topPos + 67, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/slime_obsi.png"), Identifier.parse("palamod:textures/screens/block_white.png")), e -> {
			int x = JobsminercraftguiScreen.this.x;
			int y = JobsminercraftguiScreen.this.y;
			if (true) {
		...
		imagebutton_poison_obsi = new ImageButton(this.leftPos + 67, this.topPos + 67, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/poison_obsi.png"), Identifier.parse("palamod:textures/screens/block_white.png")), e -> {
			int x = JobsminercraftguiScreen.this.x;
			int y = JobsminercraftguiScreen.this.y;
			if (true) {
		...
		imagebutton_cave_block_vfufu = new ImageButton(this.leftPos + 86, this.topPos + 67, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/cave_block_vfufu.png"), Identifier.parse("palamod:textures/screens/block_white.png")),
				e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_big_tnt_side = new ImageButton(this.leftPos + 105, this.topPos + 67, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/big_tnt_side.png"), Identifier.parse("palamod:textures/screens/block_white.png")), e -> {
			int x = JobsminercraftguiScreen.this.x;
			int y = JobsminercraftguiScreen.this.y;
			if (true) {
		...
		imagebutton_effect_tnt_side = new ImageButton(this.leftPos + 124, this.topPos + 67, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/effect_tnt_side.png"), Identifier.parse("palamod:textures/screens/block_white.png")),
				e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_wither_tnt_side = new ImageButton(this.leftPos + 143, this.topPos + 67, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/wither_tnt_side.png"), Identifier.parse("palamod:textures/screens/block_white.png")),
				e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_sponge_tnt_side = new ImageButton(this.leftPos + 162, this.topPos + 67, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/sponge_tnt_side.png"), Identifier.parse("palamod:textures/screens/block_white.png")),
				e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_sponge = new ImageButton(this.leftPos + 10, this.topPos + 86, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/sponge.png"), Identifier.parse("palamod:textures/screens/block_white.png")), e -> {
			int x = JobsminercraftguiScreen.this.x;
			int y = JobsminercraftguiScreen.this.y;
			if (true) {
		...
		imagebutton_endium_tnt_side = new ImageButton(this.leftPos + 29, this.topPos + 86, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/endium_tnt_side.png"), Identifier.parse("palamod:textures/screens/block_white.png")),
				e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_beta_block = new ImageButton(this.leftPos + 29, this.topPos + 48, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/mega_boom_obsi_side.png"), Identifier.parse("palamod:textures/screens/block_white.png")),
				e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_beta_block1 = new ImageButton(this.leftPos + 48, this.topPos + 86, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/builder_wand_amethyst.png"), Identifier.parse("palamod:textures/screens/builder_wand_white.png")), e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_beta_block2 = new ImageButton(this.leftPos + 67, this.topPos + 86, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/builder_wand_titane.png"), Identifier.parse("palamod:textures/screens/builder_wand_white.png")), e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_beta_block3 = new ImageButton(this.leftPos + 86, this.topPos + 86, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/builder_wand_paladium.png"), Identifier.parse("palamod:textures/screens/builder_wand_white.png")), e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_beta_block4 = new ImageButton(this.leftPos + 105, this.topPos + 86, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/builder_wand_endium.png"), Identifier.parse("palamod:textures/screens/builder_wand_white.png")), e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_cobblebreaker_front = new ImageButton(this.leftPos + 124, this.topPos + 86, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/cobblebreaker_front.png"), Identifier.parse("palamod:textures/screens/block_white.png")), e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_cobblebreaker_amethyst_upgrade = new ImageButton(this.leftPos + 143, this.topPos + 86, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/cobblebreaker_amethyst_upgrade.png"), Identifier.parse("palamod:textures/screens/upgrade_white.png")), e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_cobblebreaker_titane_upgrade = new ImageButton(this.leftPos + 162, this.topPos + 86, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/cobblebreaker_titane_upgrade.png"), Identifier.parse("palamod:textures/screens/upgrade_white.png")), e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_cobblebreaker_paladium_upgrade = new ImageButton(this.leftPos + 10, this.topPos + 105, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/cobblebreaker_paladium_upgrade.png"), Identifier.parse("palamod:textures/screens/upgrade_white.png")), e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_voidstone_minage = new ImageButton(this.leftPos + 29, this.topPos + 105, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/voidstone_minage.png"), Identifier.parse("palamod:textures/screens/voidstone_minage_white.png")), e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_moula_stone = new ImageButton(this.leftPos + 47, this.topPos + 105, 18, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/moula_stone.png"), Identifier.parse("palamod:textures/screens/white_moulastone.png")), e -> {
			int x = JobsminercraftguiScreen.this.x;
			int y = JobsminercraftguiScreen.this.y;
			if (true) {
		...
		imagebutton_sealed_xp_bottle = new ImageButton(this.leftPos + 70, this.topPos + 106, 11, 15,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/sealed_xp_bottle.png"), Identifier.parse("palamod:textures/screens/white_sealed_xp_bottle.png")), e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_forge_front_off = new ImageButton(this.leftPos + 86, this.topPos + 105, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/forge_front_off.png"), Identifier.parse("palamod:textures/screens/forge_front_on.png")),
				e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_beta_block5 = new ImageButton(this.leftPos + 105, this.topPos + 105, 16, 16, new WidgetSprites(Identifier.parse("palamod:textures/screens/beta_block.png"), Identifier.parse("palamod:textures/screens/block_white.png")), e -> {
			int x = JobsminercraftguiScreen.this.x;
			int y = JobsminercraftguiScreen.this.y;
			if (true) {
		...
		imagebutton_withered_obsidian_0 = new ImageButton(this.leftPos + 124, this.topPos + 105, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/withered_obsidian_0.png"), Identifier.parse("palamod:textures/screens/block_white.png")), e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
		...
		imagebutton_green_paladium_excavator = new ImageButton(this.leftPos + 143, this.topPos + 105, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/green_paladium_excavator.png"), Identifier.parse("palamod:textures/screens/paladium_excavator_white.png")), e -> {
					int x = JobsminercraftguiScreen.this.x;
					int y = JobsminercraftguiScreen.this.y;
					if (true) {
