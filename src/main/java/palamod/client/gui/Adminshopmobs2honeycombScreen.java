...
public class Adminshopmobs2honeycombScreen extends AbstractContainerScreen<Adminshopmobs2honeycombMenu> implements PalamodModScreens.ScreenAccessor {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, AdshoppreviewamounthoneycombProcedure.execute(world, entity), 29, 74, -4671036, false);
	...
	public void init() {
		...
		number_buy.setHint(Component.translatable("gui.palamod.adminshopmobs_2honeycomb.number_buy"));
		...
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshopmobs_2honeycomb.button_buy"), e -> {
			int x = Adminshopmobs2honeycombScreen.this.x;
			int y = Adminshopmobs2honeycombScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new Adminshopmobs2honeycombButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshopmobs_2honeycomb.button_sell"), e -> {
			...
			int y = Adminshopmobs2honeycombScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new Adminshopmobs2honeycombButtonMessage(1, x, y, z));
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 154, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/cross_no_button.png"), ResourceLocation.parse("palamod:textures/screens/pointed_cross_no_button.png")), e -> {
					...
					int y = Adminshopmobs2honeycombScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new Adminshopmobs2honeycombButtonMessage(2, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 136, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/arrow_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/arrow_adminshop_poi.png")), e -> {
					...
					int y = Adminshopmobs2honeycombScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new Adminshopmobs2honeycombButtonMessage(3, x, y, z));
		...
		imagebutton_home_pixel_adminshop = new ImageButton(this.leftPos + 118, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/home_pixel_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/pointec_home_pixel_adminshop.png")), e -> {
					...
					int y = Adminshopmobs2honeycombScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new Adminshopmobs2honeycombButtonMessage(4, x, y, z));
