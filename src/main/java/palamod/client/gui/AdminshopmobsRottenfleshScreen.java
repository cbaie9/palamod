...
public class AdminshopmobsRottenfleshScreen extends AbstractContainerScreen<AdminshopmobsRottenfleshMenu> implements PalamodModScreens.ScreenAccessor {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, AdshoppreviewamountrottenfleshProcedure.execute(world, entity), 29, 74, -4671036, false);
	...
	public void init() {
		...
		number_buy.setHint(Component.translatable("gui.palamod.adminshopmobs_rottenflesh.number_buy"));
		...
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshopmobs_rottenflesh.button_buy"), e -> {
			int x = AdminshopmobsRottenfleshScreen.this.x;
			int y = AdminshopmobsRottenfleshScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshopmobsRottenfleshButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshopmobs_rottenflesh.button_sell"), e -> {
			...
			int y = AdminshopmobsRottenfleshScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshopmobsRottenfleshButtonMessage(1, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 133, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/arrow_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/arrow_adminshop_poi.png")), e -> {
					...
					int y = AdminshopmobsRottenfleshScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshopmobsRottenfleshButtonMessage(3, x, y, z));
		...
		imagebutton_home_pixel_adminshop = new ImageButton(this.leftPos + 116, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/home_pixel_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/pointec_home_pixel_adminshop.png")), e -> {
					...
					int y = AdminshopmobsRottenfleshScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshopmobsRottenfleshButtonMessage(4, x, y, z));
