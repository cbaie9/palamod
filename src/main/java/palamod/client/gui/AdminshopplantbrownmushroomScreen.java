...
public class AdminshopplantbrownmushroomScreen extends AbstractContainerScreen<AdminshopplantbrownmushroomMenu> {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 154 && mouseX < leftPos + 170 && mouseY > topPos + 4 && mouseY < topPos + 20)
			guiGraphics.renderTooltip(font, Component.translatable("gui.palamod.adminshopplantbrownmushroom.tooltip_close_the_gui"), mouseX, mouseY);
		if (mouseX > leftPos + 136 && mouseX < leftPos + 151 && mouseY > topPos + 6 && mouseY < topPos + 20)
			guiGraphics.renderTooltip(font, Component.translatable("gui.palamod.adminshopplantbrownmushroom.tooltip_return_to_the_adminshop_plant_me"), mouseX, mouseY);
		if (mouseX > leftPos + 120 && mouseX < leftPos + 132 && mouseY > topPos + 5 && mouseY < topPos + 20)
			guiGraphics.renderTooltip(font, Component.translatable("gui.palamod.adminshopplantbrownmushroom.tooltip_return_to_the_adminshop_menu"), mouseX, mouseY);
	}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, Component.translatable("gui.palamod.adminshopplantbrownmushroom.label_sell_price_120"), 25, 30, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.palamod.adminshopplantbrownmushroom.label_buy_price_125"), 25, 44, -12829636, false);
	}
	...
	public void init() {
		...
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshopplantbrownmushroom.button_buy"), e -> {
			if (true) {
				PalamodMod.PACKET_HANDLER.sendToServer(new AdminshopplantbrownmushroomButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshopplantbrownmushroom.button_sell"), e -> {
			if (true) {
				PalamodMod.PACKET_HANDLER.sendToServer(new AdminshopplantbrownmushroomButtonMessage(1, x, y, z));
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 154, this.topPos + 4, 16, 16, 0, 0, 16, new ResourceLocation("palamod:textures/screens/atlas/imagebutton_cross_no_button.png"), 16, 32, e -> {
			if (true) {
				PalamodMod.PACKET_HANDLER.sendToServer(new AdminshopplantbrownmushroomButtonMessage(2, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 135, this.topPos + 4, 16, 16, 0, 0, 16, new ResourceLocation("palamod:textures/screens/atlas/imagebutton_arrow_adminshop.png"), 16, 32, e -> {
			if (true) {
				PalamodMod.PACKET_HANDLER.sendToServer(new AdminshopplantbrownmushroomButtonMessage(3, x, y, z));
		...
		imagebutton_home_pixel_adminshop = new ImageButton(this.leftPos + 118, this.topPos + 4, 16, 16, 0, 0, 16, new ResourceLocation("palamod:textures/screens/atlas/imagebutton_home_pixel_adminshop.png"), 16, 32, e -> {
			if (true) {
				PalamodMod.PACKET_HANDLER.sendToServer(new AdminshopplantbrownmushroomButtonMessage(4, x, y, z));
