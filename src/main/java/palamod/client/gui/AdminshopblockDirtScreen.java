...
public class AdminshopblockDirtScreen extends AbstractContainerScreen<AdminshopblockDirtMenu> implements PalamodModScreens.ScreenAccessor {
	...
	public void init() {
		...
		number_buy.setHint(Component.translatable("gui.palamod.adminshopblock_dirt.number_buy"));
		...
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshopblock_dirt.button_buy"), e -> {
			...
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshopblockDirtButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshopblock_dirt.button_sell"), e -> {
			...
			int y = AdminshopblockDirtScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshopblockDirtButtonMessage(1, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 136, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/arrow_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/arrow_adminshop_poi.png")), e -> {
					...
					int y = AdminshopblockDirtScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshopblockDirtButtonMessage(2, x, y, z));
		...
		imagebutton_home_pixel_adminshop = new ImageButton(this.leftPos + 120, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/home_pixel_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/pointec_home_pixel_adminshop.png")), e -> {
					...
					int y = AdminshopblockDirtScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshopblockDirtButtonMessage(3, x, y, z));
