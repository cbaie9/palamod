...
public class AdminshoporeironScreen extends AbstractContainerScreen<AdminshoporeironMenu> implements PalamodModScreens.ScreenAccessor {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, AdshoppreviewamountironProcedure.execute(world, entity), 29, 74, -4671036, false);
	...
	public void init() {
		...
		number_buy.setHint(Component.translatable("gui.palamod.adminshoporeiron.number_buy"));
		...
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshoporeiron.button_buy"), e -> {
			...
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshoporeironButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshoporeiron.button_sell"), e -> {
			...
			int y = AdminshoporeironScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshoporeironButtonMessage(1, x, y, z));
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 155, this.topPos + 3, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/cross_no_button.png"), ResourceLocation.parse("palamod:textures/screens/pointed_cross_no_button.png")), e -> {
					...
					int y = AdminshoporeironScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshoporeironButtonMessage(2, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 137, this.topPos + 3, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/arrow_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/arrow_adminshop_poi.png")), e -> {
					...
					int y = AdminshoporeironScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshoporeironButtonMessage(3, x, y, z));
		...
		imagebutton_home_pixel_adminshop = new ImageButton(this.leftPos + 121, this.topPos + 3, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/home_pixel_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/pointec_home_pixel_adminshop.png")), e -> {
					...
					int y = AdminshoporeironScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshoporeironButtonMessage(4, x, y, z));
