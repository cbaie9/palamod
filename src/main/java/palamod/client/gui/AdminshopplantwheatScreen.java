...
public class AdminshopplantwheatScreen extends AbstractContainerScreen<AdminshopplantwheatMenu> implements PalamodModScreens.ScreenAccessor {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, AdshoppreviewamountwheatProcedure.execute(world, entity), 29, 77, -4671036, false);
	}
	...
	public void init() {
		...
		number_buy.setHint(Component.translatable("gui.palamod.adminshopplantwheat.number_buy"));
		...
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshopplantwheat.button_buy"), e -> {
			int x = AdminshopplantwheatScreen.this.x;
			int y = AdminshopplantwheatScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshopplantwheatButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshopplantwheat.button_sell"), e -> {
			...
			int y = AdminshopplantwheatScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshopplantwheatButtonMessage(1, x, y, z));
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 153, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/cross_no_button.png"), ResourceLocation.parse("palamod:textures/screens/pointed_cross_no_button.png")), e -> {
					...
					int y = AdminshopplantwheatScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshopplantwheatButtonMessage(2, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 134, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/arrow_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/arrow_adminshop_poi.png")), e -> {
					...
					int y = AdminshopplantwheatScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshopplantwheatButtonMessage(3, x, y, z));
		...
		imagebutton_home_pixel_adminshop = new ImageButton(this.leftPos + 117, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/home_pixel_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/pointec_home_pixel_adminshop.png")), e -> {
					...
					int y = AdminshopplantwheatScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshopplantwheatButtonMessage(4, x, y, z));
