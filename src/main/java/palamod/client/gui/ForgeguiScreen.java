...
public class ForgeguiScreen extends AbstractContainerScreen<ForgeguiMenu> implements PalamodModScreens.ScreenAccessor {
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		guiGraphics.text(this.font, Component.translatable("gui.palamod.forgegui.label_forge"), 71, 3, -1, false);
		guiGraphics.text(this.font, Component.translatable("gui.palamod.forgegui.label_inventory"), 6, 72, -1, false);
	}
