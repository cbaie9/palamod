...
public class Adminshopmobs2gunpowderScreen extends AbstractContainerScreen<Adminshopmobs2gunpowderMenu> implements PalamodModScreens.ScreenAccessor {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, AdshoppreviewamountgunpowderProcedure.execute(world, entity), 29, 74, -4671036, false);
	...
	public void init() {
		...
		number_buy.setHint(Component.translatable("gui.palamod.adminshopmobs_2gunpowder.number_buy"));
		...
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshopmobs_2gunpowder.button_buy"), e -> {
			int x = Adminshopmobs2gunpowderScreen.this.x;
			int y = Adminshopmobs2gunpowderScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new Adminshopmobs2gunpowderButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshopmobs_2gunpowder.button_sell"), e -> {
			...
			int y = Adminshopmobs2gunpowderScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new Adminshopmobs2gunpowderButtonMessage(1, x, y, z));
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 153, this.topPos + 3, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/cross_no_button.png"), ResourceLocation.parse("palamod:textures/screens/pointed_cross_no_button.png")), e -> {
					...
					int y = Adminshopmobs2gunpowderScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new Adminshopmobs2gunpowderButtonMessage(2, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 134, this.topPos + 3, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/arrow_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/arrow_adminshop_poi.png")), e -> {
					...
					int y = Adminshopmobs2gunpowderScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new Adminshopmobs2gunpowderButtonMessage(3, x, y, z));
		...
		imagebutton_home_pixel_adminshop = new ImageButton(this.leftPos + 118, this.topPos + 3, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/home_pixel_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/pointec_home_pixel_adminshop.png")), e -> {
					...
					int y = Adminshopmobs2gunpowderScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new Adminshopmobs2gunpowderButtonMessage(4, x, y, z));
