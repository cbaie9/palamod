...
public class ExamplegrinderguiScreen extends AbstractContainerScreen<ExamplegrinderguiMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("palamod:textures/screens/arrow_1red_new.png"), this.leftPos + 54, this.topPos + 62, 0, 0, 24, 10, 24, 10);

		if (Grindersubprocessarrowsplit1Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("palamod:textures/screens/arrow_3red_new.png"), this.leftPos + 54, this.topPos + 62, 0, 0, 24, 10, 24, 10);
		}
		if (Grindersubprocessarrowsplit2Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("palamod:textures/screens/arrow_5red_new.png"), this.leftPos + 54, this.topPos + 62, 0, 0, 24, 10, 24, 10);
		}
		if (Grindersubprocessarrowsplit3Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("palamod:textures/screens/arrow_7red_new.png"), this.leftPos + 54, this.topPos + 62, 0, 0, 24, 10, 24, 10);
		}
		if (Grindersubprocessarrowsplit4Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("palamod:textures/screens/arrow_9red_new.png"), this.leftPos + 54, this.topPos + 62, 0, 0, 24, 10, 24, 10);
		}
		if (Grindersubprocessarrowsplit5Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("palamod:textures/screens/arrow_11red_new.png"), this.leftPos + 54, this.topPos + 62, 0, 0, 24, 10, 24, 10);
		}
		if (Grindersubprocessarrowsplit6Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("palamod:textures/screens/arrow_13red_new.png"), this.leftPos + 54, this.topPos + 62, 0, 0, 24, 10, 24, 10);
		}
		if (Grindersubprocessarrowsplit7Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("palamod:textures/screens/arrow_15red_new.png"), this.leftPos + 54, this.topPos + 62, 0, 0, 24, 10, 24, 10);
		}
		if (Grindersubprocessarrowsplit8Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("palamod:textures/screens/arrow_17red_new.png"), this.leftPos + 54, this.topPos + 62, 0, 0, 24, 10, 24, 10);
		}
		if (Grindersubprocessarrowsplit9Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("palamod:textures/screens/arrow_18red_new.png"), this.leftPos + 54, this.topPos + 62, 0, 0, 24, 10, 24, 10);
		}
		if (Grindersubprocessarrowsplit10Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("palamod:textures/screens/arrow_19red_new.png"), this.leftPos + 54, this.topPos + 62, 0, 0, 24, 10, 24, 10);
		}
