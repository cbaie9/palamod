...
public class JobsfarmerguiScreen extends AbstractContainerScreen<JobsfarmerguiMenu> {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 14 && mouseX < leftPos + 159 && mouseY > topPos + 26 && mouseY < topPos + 36)
			guiGraphics.renderTooltip(font, Component.literal(GetxpfarmertextProcedure.execute(entity)), mouseX, mouseY);
	}
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(ResourceLocation.parse("palamod:textures/screens/pgbar_jobs.png"), this.leftPos + 14, this.topPos + 26, Mth.clamp((int) JobsfarmergetxpprogressbarProcedure.execute(entity) * 155, 0, 14345), 0, 155, 10, 14500, 10);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font,
				...
				GetxpfarmerProcedure.execute(entity), 13, 38, -12829636, false);
	}
