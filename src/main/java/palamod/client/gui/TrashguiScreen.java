...
public class TrashguiScreen extends AbstractContainerScreen<TrashguiMenu> implements PalamodModScreens.ScreenAccessor {
	...
	private static final Identifier IMAGE_0 = Identifier.parse("palamod:textures/screens/trashgui.png");
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		guiGraphics.text(this.font, Component.translatable("gui.palamod.trashgui.label_voidstone_gui_trash_bin"), 17, 4, -1, false);
		guiGraphics.text(this.font, Component.translatable("gui.palamod.trashgui.label_inventory"), 6, 70, -12829636, false);
	}
	...
	public void init() {
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 155, this.topPos + 3, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/cross_no_button.png"), Identifier.parse("palamod:textures/screens/pointed_cross_no_button.png")), e -> {
					...
					if (true) {
						ClientPacketDistributor.sendToServer(new TrashguiButtonMessage(0, x, y, z));
