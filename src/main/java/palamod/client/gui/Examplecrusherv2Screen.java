...
public class Examplecrusherv2Screen extends AbstractContainerScreen<Examplecrusherv2Menu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("palamod:textures/screens/examplecrusherv_2.png"), this.leftPos + 0, this.topPos + 0, 0, 0, 335, 205, 335, 205);
		...
		guiGraphics.blit(new ResourceLocation("palamod:textures/screens/palamixed2.png"), this.leftPos + 175, this.topPos + 179, 0, 0, 16, 16, 16, 16);
