...
public class BackpackendiumScreen extends AbstractContainerScreen<BackpackendiumMenu> {
	private final static HashMap<String, Object> guistate = BackpackendiumMenu.guistate;
