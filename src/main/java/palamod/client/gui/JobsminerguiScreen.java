...
public class JobsminerguiScreen extends AbstractContainerScreen<JobsminerguiMenu> {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 14 && mouseX < leftPos + 159 && mouseY > topPos + 26 && mouseY < topPos + 36)
			guiGraphics.renderTooltip(font, Component.literal(GetxpminertextProcedure.execute(world, x, y, z, entity)), mouseX, mouseY);
	}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font,
				...
				GetxpminerProcedure.execute(world, x, y, z, entity), 13, 38, -12829636, false);
	}
