...
public class Adminshopmobs2blazeScreen extends AbstractContainerScreen<Adminshopmobs2blazeMenu> implements PalamodModScreens.ScreenAccessor {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, AdshoppreviewamountblazeProcedure.execute(world, entity), 29, 74, -4671036, false);
	...
	public void init() {
		...
		number_buy.setHint(Component.translatable("gui.palamod.adminshopmobs_2blaze.number_buy"));
		...
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshopmobs_2blaze.button_buy"), e -> {
			int x = Adminshopmobs2blazeScreen.this.x;
			int y = Adminshopmobs2blazeScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new Adminshopmobs2blazeButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshopmobs_2blaze.button_sell"), e -> {
			...
			int y = Adminshopmobs2blazeScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new Adminshopmobs2blazeButtonMessage(1, x, y, z));
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 151, this.topPos + 5, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/cross_no_button.png"), ResourceLocation.parse("palamod:textures/screens/pointed_cross_no_button.png")), e -> {
					...
					int y = Adminshopmobs2blazeScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new Adminshopmobs2blazeButtonMessage(2, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 131, this.topPos + 5, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/arrow_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/arrow_adminshop_poi.png")), e -> {
					...
					int y = Adminshopmobs2blazeScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new Adminshopmobs2blazeButtonMessage(3, x, y, z));
		...
		imagebutton_home_pixel_adminshop = new ImageButton(this.leftPos + 114, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/home_pixel_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/pointec_home_pixel_adminshop.png")), e -> {
					...
					int y = Adminshopmobs2blazeScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new Adminshopmobs2blazeButtonMessage(4, x, y, z));
