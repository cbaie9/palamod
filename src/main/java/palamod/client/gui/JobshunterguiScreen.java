...
public class JobshunterguiScreen extends AbstractContainerScreen<JobshunterguiMenu> implements PalamodModScreens.ScreenAccessor {
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		guiGraphics.text(this.font, Component.translatable("gui.palamod.jobshuntergui.label_jobs_miner"), 9, 7, -1, false);
		guiGraphics.text(this.font, GetxphunterProcedure.execute(entity), 13, 38, -1, false);
		guiGraphics.text(this.font, GetlevelhunterProcedure.execute(entity), 5, 63, -1, false);
	}
