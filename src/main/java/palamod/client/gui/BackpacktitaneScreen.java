...
public class BackpacktitaneScreen extends AbstractContainerScreen<BackpacktitaneMenu> implements PalamodModScreens.ScreenAccessor {
	...
	private static final Identifier IMAGE_0 = Identifier.parse("palamod:textures/screens/backpacktitane.png");
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		guiGraphics.text(this.font, Component.translatable("gui.palamod.backpacktitane.label_inventory"), 7, 71, -1, false);
		guiGraphics.text(this.font, Component.translatable("gui.palamod.backpacktitane.label_backpack"), 7, 5, -1, false);
	}
