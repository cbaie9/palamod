...
public class BackpacktitaneScreen extends AbstractContainerScreen<BackpacktitaneMenu> implements PalamodModScreens.ScreenAccessor {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, ResourceLocation.parse("palamod:textures/screens/backpacktitane.png"), this.leftPos + 0, this.topPos + 0, 0, 0, 176, 168, 176, 168);
	}
