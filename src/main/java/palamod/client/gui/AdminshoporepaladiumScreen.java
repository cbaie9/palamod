...
public class AdminshoporepaladiumScreen extends AbstractContainerScreen<AdminshoporepaladiumMenu> implements PalamodModScreens.ScreenAccessor {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, AdshoppreviewamountpalaProcedure.execute(world, entity), 29, 74, -4671036, false);
	...
	public void init() {
		...
		number_buy.setHint(Component.translatable("gui.palamod.adminshoporepaladium.number_buy"));
		...
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshoporepaladium.button_buy"), e -> {
			int x = AdminshoporepaladiumScreen.this.x;
			int y = AdminshoporepaladiumScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshoporepaladiumButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshoporepaladium.button_sell"), e -> {
			...
			int y = AdminshoporepaladiumScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshoporepaladiumButtonMessage(1, x, y, z));
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 154, this.topPos + 3, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/cross_no_button.png"), ResourceLocation.parse("palamod:textures/screens/pointed_cross_no_button.png")), e -> {
					...
					int y = AdminshoporepaladiumScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshoporepaladiumButtonMessage(2, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 135, this.topPos + 3, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/arrow_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/arrow_adminshop_poi.png")), e -> {
					...
					int y = AdminshoporepaladiumScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshoporepaladiumButtonMessage(3, x, y, z));
		...
		imagebutton_home_pixel_adminshop = new ImageButton(this.leftPos + 117, this.topPos + 3, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/home_pixel_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/pointec_home_pixel_adminshop.png")), e -> {
					...
					int y = AdminshoporepaladiumScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshoporepaladiumButtonMessage(4, x, y, z));
