...
public class AdminshopplantredmushroomScreen extends AbstractContainerScreen<AdminshopplantredmushroomMenu> implements PalamodModScreens.ScreenAccessor {
	...
	public void init() {
		...
		number_buy.setHint(Component.translatable("gui.palamod.adminshopplantredmushroom.number_buy"));
		...
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshopplantredmushroom.button_buy"), e -> {
			int x = AdminshopplantredmushroomScreen.this.x;
			int y = AdminshopplantredmushroomScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshopplantredmushroomButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshopplantredmushroom.button_sell"), e -> {
			...
			int y = AdminshopplantredmushroomScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshopplantredmushroomButtonMessage(1, x, y, z));
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 153, this.topPos + 5, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/cross_no_button.png"), ResourceLocation.parse("palamod:textures/screens/pointed_cross_no_button.png")), e -> {
					...
					int y = AdminshopplantredmushroomScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshopplantredmushroomButtonMessage(2, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 135, this.topPos + 5, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/arrow_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/arrow_adminshop_poi.png")), e -> {
					...
					int y = AdminshopplantredmushroomScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshopplantredmushroomButtonMessage(3, x, y, z));
		...
		imagebutton_home_pixel_adminshop = new ImageButton(this.leftPos + 118, this.topPos + 5, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/home_pixel_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/pointec_home_pixel_adminshop.png")), e -> {
					...
					int y = AdminshopplantredmushroomScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshopplantredmushroomButtonMessage(4, x, y, z));
