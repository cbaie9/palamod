...
import palamod.network.NewAdminshopguiButtonMessage;
...
public class NewAdminshopguiScreen extends AbstractContainerScreen<NewAdminshopguiMenu> implements PalamodModScreens.ScreenAccessor {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, ResourceLocation.parse("palamod:textures/screens/xp_berry.png"), this.leftPos + 5, this.topPos + 4, 0, 0, 16, 16, 16, 16);
	}
	...
	public void init() {
		...
		number_buy.setHint(Component.translatable("gui.palamod.new_adminshopgui.number_buy"));
		this.addWidget(this.number_buy);
		button_buy = Button.builder(Component.translatable("gui.palamod.new_adminshopgui.button_buy"), e -> {
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.new_adminshopgui.button_sell"), e -> {
			int x = NewAdminshopguiScreen.this.x;
			int y = NewAdminshopguiScreen.this.y;
			if (true) {
