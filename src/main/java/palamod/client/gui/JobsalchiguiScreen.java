...
public class JobsalchiguiScreen extends AbstractContainerScreen<JobsalchiguiMenu> implements PalamodModScreens.ScreenAccessor {
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		guiGraphics.text(this.font, Component.translatable("gui.palamod.jobsalchigui.label_jobs_miner"), 9, 7, -1, false);
		guiGraphics.text(this.font, GetxpalchiProcedure.execute(entity), 13, 38, -1, false);
		guiGraphics.text(this.font, GetlevelalchiProcedure.execute(entity), 5, 63, -1, false);
	}
