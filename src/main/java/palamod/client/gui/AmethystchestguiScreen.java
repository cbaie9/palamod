...
public class AmethystchestguiScreen extends AbstractContainerScreen<AmethystchestguiMenu> implements PalamodModScreens.ScreenAccessor {
	...
	private static final Identifier IMAGE_0 = Identifier.parse("palamod:textures/screens/amethystchestgui.png");
	private static final Identifier IMAGE_1 = Identifier.parse("palamod:textures/screens/ring_gui.png");
	private static final Identifier IMAGE_2 = Identifier.parse("palamod:textures/screens/ring_to_set.png");
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		guiGraphics.text(this.font, Component.translatable("gui.palamod.amethystchestgui.label_inventory"), 70, 130, -12829636, false);
		guiGraphics.text(this.font, Component.translatable("gui.palamod.amethystchestgui.label_rings"), 255, 149, -12829636, false);
	}
