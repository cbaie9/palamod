...
public class AdminshopblockGlowstoneScreen extends AbstractContainerScreen<AdminshopblockGlowstoneMenu> implements PalamodModScreens.ScreenAccessor {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, AdshoppreviewamountglowstoneProcedure.execute(world, entity), 26, 76, -4671036, false);
	...
	public void init() {
		...
		number_buy.setHint(Component.translatable("gui.palamod.adminshopblock_glowstone.number_buy"));
		...
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshopblock_glowstone.button_buy"), e -> {
			int x = AdminshopblockGlowstoneScreen.this.x;
			int y = AdminshopblockGlowstoneScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshopblockGlowstoneButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshopblock_glowstone.button_sell"), e -> {
			...
			int y = AdminshopblockGlowstoneScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshopblockGlowstoneButtonMessage(1, x, y, z));
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 153, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/cross_no_button.png"), ResourceLocation.parse("palamod:textures/screens/pointed_cross_no_button.png")), e -> {
					...
					int y = AdminshopblockGlowstoneScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshopblockGlowstoneButtonMessage(2, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 135, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/arrow_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/arrow_adminshop_poi.png")), e -> {
					...
					int y = AdminshopblockGlowstoneScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshopblockGlowstoneButtonMessage(3, x, y, z));
		...
		imagebutton_home_pixel_adminshop = new ImageButton(this.leftPos + 118, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/home_pixel_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/pointec_home_pixel_adminshop.png")), e -> {
					...
					int y = AdminshopblockGlowstoneScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshopblockGlowstoneButtonMessage(4, x, y, z));
