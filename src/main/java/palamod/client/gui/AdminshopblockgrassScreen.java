...
public class AdminshopblockgrassScreen extends AbstractContainerScreen<AdminshopblockgrassMenu> {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 115 && mouseX < leftPos + 127 && mouseY > topPos + 5 && mouseY < topPos + 20)
			guiGraphics.renderTooltip(font, Component.translatable("gui.palamod.adminshopblockgrass.tooltip_return_to_the_adminshop_menu"), mouseX, mouseY);
	}
	...
	public void init() {
		...
		imagebutton_home_pixel_adminshop = new ImageButton(this.leftPos + 113, this.topPos + 4, 16, 16, 0, 0, 16, new ResourceLocation("palamod:textures/screens/atlas/imagebutton_home_pixel_adminshop.png"), 16, 32, e -> {
			if (true) {
				PalamodMod.PACKET_HANDLER.sendToServer(new AdminshopblockgrassButtonMessage(3, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 132, this.topPos + 4, 16, 16, 0, 0, 16, new ResourceLocation("palamod:textures/screens/atlas/imagebutton_arrow_adminshop.png"), 16, 32, e -> {
			if (true) {
				PalamodMod.PACKET_HANDLER.sendToServer(new AdminshopblockgrassButtonMessage(4, x, y, z));
