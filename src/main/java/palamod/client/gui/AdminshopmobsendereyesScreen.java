...
public class AdminshopmobsendereyesScreen extends AbstractContainerScreen<AdminshopmobsendereyesMenu> implements PalamodModScreens.ScreenAccessor {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, AdshoppreviewamountendereyesProcedure.execute(world, entity), 29, 74, -4671036, false);
	...
	public void init() {
		...
		number_buy.setHint(Component.translatable("gui.palamod.adminshopmobsendereyes.number_buy"));
		...
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshopmobsendereyes.button_buy"), e -> {
			int x = AdminshopmobsendereyesScreen.this.x;
			int y = AdminshopmobsendereyesScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshopmobsendereyesButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshopmobsendereyes.button_sell"), e -> {
			...
			int y = AdminshopmobsendereyesScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshopmobsendereyesButtonMessage(1, x, y, z));
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 152, this.topPos + 5, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/cross_no_button.png"), ResourceLocation.parse("palamod:textures/screens/pointed_cross_no_button.png")), e -> {
					...
					int y = AdminshopmobsendereyesScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshopmobsendereyesButtonMessage(2, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 133, this.topPos + 5, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/arrow_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/arrow_adminshop_poi.png")), e -> {
					...
					int y = AdminshopmobsendereyesScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshopmobsendereyesButtonMessage(3, x, y, z));
		...
		imagebutton_home_pixel_adminshop = new ImageButton(this.leftPos + 115, this.topPos + 5, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/home_pixel_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/pointec_home_pixel_adminshop.png")), e -> {
					...
					int y = AdminshopmobsendereyesScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshopmobsendereyesButtonMessage(4, x, y, z));
