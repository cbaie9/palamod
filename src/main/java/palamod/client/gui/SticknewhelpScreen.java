...
public class SticknewhelpScreen extends AbstractContainerScreen<SticknewhelpMenu> implements PalamodModScreens.ScreenAccessor {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, ResourceLocation.parse("palamod:textures/screens/sticknewhelp.png"), this.leftPos + 0, this.topPos + 0, 0, 0, 400, 225, 400, 225);
		...
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, ResourceLocation.parse("palamod:textures/screens/right_gray_line.png"), this.leftPos + 300, this.topPos + 0, 0, 0, 100, 24, 100, 24);
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, ResourceLocation.parse("palamod:textures/screens/arrow_new.png"), this.leftPos + 331, this.topPos + 144, 0, 0, 24, 10, 24, 10);
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, ResourceLocation.parse("palamod:textures/screens/mid_gray_line.png"), this.leftPos + 260, this.topPos + 0, 0, 0, 100, 24, 100, 24);
	}
