...
public class TrixiumdepositScreen extends AbstractContainerScreen<TrixiumdepositMenu> implements PalamodModScreens.ScreenAccessor {
	...
	private static final ResourceLocation IMAGE_0 = ResourceLocation.parse("palamod:textures/screens/trixiumdeposit.png");
	private static final ResourceLocation IMAGE_1 = ResourceLocation.parse("palamod:textures/screens/trixium.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiGraphics.blit(IMAGE_1, this.leftPos + 80, this.topPos + 42, 0, 0, 16, 16, 16, 16);
