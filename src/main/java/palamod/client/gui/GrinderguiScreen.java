...
public class GrinderguiScreen extends AbstractContainerScreen<GrinderguiMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		Grindersubprocessarrowinsertn0Procedure.execute(world, x, y, z)
		...
		Grindersubprocessarrowinsertn1Procedure.execute(world, x, y, z)
		...
		Grindersubprocessarrowinsertn2Procedure.execute(world, x, y, z)
		...
		Grindersubprocessarrowinsertn3Procedure.execute(world, x, y, z)
		...
		Grindersubprocessarrowinsertn4Procedure.execute(world, x, y, z)
		...
		Grinderguiarrow2n1Procedure.execute(world, x, y, z)
		...
		Grinderguiarrow2n2Procedure.execute(world, x, y, z)
		...
		Grinderguiarrow2n3Procedure.execute(world, x, y, z)
		...
		Grinderguiarrow2n4Procedure.execute(world, x, y, z)
		...
		Grinderguiarrow2n5Procedure.execute(world, x, y, z)
		...
		Grinderguiarrow2n7Procedure.execute(world, x, y, z)
		...
		Grinderguiarrow2n8Procedure.execute(world, x, y, z)
		...
		Grinderguiarrow2n9Procedure.execute(world, x, y, z)
		...
		Grinderguiarrow2n10Procedure.execute(world, x, y, z)
		...
		Grindersubprocessarrowsplit1Procedure.execute(world, x, y, z)
		...
		Grindersubprocessarrowsplit2Procedure.execute(world, x, y, z)
		...
		Grindersubprocessarrowsplit3Procedure.execute(world, x, y, z)
		...
		Grindersubprocessarrowsplit4Procedure.execute(world, x, y, z)
		...
		Grindersubprocessarrowsplit5Procedure.execute(world, x, y, z)
		...
		Grindersubprocessarrowsplit6Procedure.execute(world, x, y, z)
		...
		Grindersubprocessarrowsplit7Procedure.execute(world, x, y, z)
		...
		Grindersubprocessarrowsplit8Procedure.execute(world, x, y, z)
		...
		Grindersubprocessarrowsplit9Procedure.execute(world, x, y, z)
		...
		Grindersubprocessarrowsplit10Procedure.execute(world, x, y, z)
