...
public class TitanechestguiScreen extends AbstractContainerScreen<TitanechestguiMenu> implements PalamodModScreens.ScreenAccessor {
	...
	private static final Identifier IMAGE_0 = Identifier.parse("palamod:textures/screens/titanechestgui.png");
	...
	public void extractBackground(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_2, this.leftPos + 260, this.topPos + 163, 0, 0, 16, 16, 16, 16);
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_3, this.leftPos + 260, this.topPos + 181, 0, 0, 16, 16, 16, 16);
	}
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		guiGraphics.text(this.font, Component.translatable("gui.palamod.titanechestgui.label_inventory"), 70, 132, -12829636, false);
		guiGraphics.text(this.font, Component.translatable("gui.palamod.titanechestgui.label_rings"), 254, 147, -12829636, false);
	}
