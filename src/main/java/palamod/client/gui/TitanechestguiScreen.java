...
public class TitanechestguiScreen extends AbstractContainerScreen<TitanechestguiMenu> implements PalamodModScreens.ScreenAccessor {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, ResourceLocation.parse("palamod:textures/screens/titanechestgui.png"), this.leftPos + 0, this.topPos + 0, 0, 0, 306, 225, 306, 225);
		...
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, ResourceLocation.parse("palamod:textures/screens/ring_gui.png"), this.leftPos + 260, this.topPos + 181, 0, 0, 16, 16, 16, 16);
	}
