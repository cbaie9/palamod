...
public class CrusherguiScreen extends AbstractContainerScreen<CrusherguiMenu> implements PalamodModScreens.ScreenAccessor {
	...
	private static final Identifier IMAGE_0 = Identifier.parse("palamod:textures/screens/crusher_gui_v2.png");
	private static final Identifier IMAGE_1 = Identifier.parse("palamod:textures/screens/amethystmixedcoal.png");
	private static final Identifier IMAGE_2 = Identifier.parse("palamod:textures/screens/titanemixedcoal.png");
	private static final Identifier IMAGE_3 = Identifier.parse("palamod:textures/screens/goldmixedcoal.png");
	private static final Identifier IMAGE_4 = Identifier.parse("palamod:textures/screens/palamixedcoal.png");
	private static final Identifier IMAGE_5 = Identifier.parse("palamod:textures/screens/eggplante_crusher_v2.png");
	private static final Identifier IMAGE_6 = Identifier.parse("palamod:textures/screens/amethyst_ingot.png");
	private static final Identifier IMAGE_7 = Identifier.parse("palamod:textures/screens/titane_ingot.png");
	private static final Identifier IMAGE_8 = Identifier.parse("palamod:textures/screens/endium_nugets_vfufu.png");
	private static final Identifier IMAGE_9 = Identifier.parse("palamod:textures/screens/paladium_ingot.png");
	private static final Identifier IMAGE_10 = Identifier.parse("palamod:textures/screens/fuel_crusher.png");
	private static final Identifier IMAGE_11 = Identifier.parse("palamod:textures/screens/no_plant_crusher.png");
	private static final Identifier IMAGE_12 = Identifier.parse("palamod:textures/screens/no_plant_crusher.png");
	private static final Identifier IMAGE_13 = Identifier.parse("palamod:textures/screens/no_plant_crusher.png");
	private static final Identifier IMAGE_14 = Identifier.parse("palamod:textures/screens/no_plant_crusher.png");
	private static final Identifier IMAGE_15 = Identifier.parse("palamod:textures/screens/delim_amethyst_crusher.png");
	private static final Identifier IMAGE_16 = Identifier.parse("palamod:textures/screens/delim_titane_crusher.png");
	private static final Identifier IMAGE_17 = Identifier.parse("palamod:textures/screens/delim_endium_crusher.png");
	private static final Identifier IMAGE_18 = Identifier.parse("palamod:textures/screens/delim_paladium_crusher.png");
	private static final Identifier SPRITE_0 = Identifier.parse("palamod:textures/screens/pgbar_ame_full.png");
	private static final Identifier SPRITE_1 = Identifier.parse("palamod:textures/screens/titane_pgbar_full.png");
	private static final Identifier SPRITE_2 = Identifier.parse("palamod:textures/screens/paladium_pgbar_full.png");
	private static final Identifier SPRITE_3 = Identifier.parse("palamod:textures/screens/pgbar_endium_v1.2.png");
	private static final Identifier SPRITE_4 = Identifier.parse("palamod:textures/screens/flamme_crusher_sprite.png");

	public CrusherguiScreen(CrusherguiMenu container, Inventory inventory, Component text) {
		super(container, inventory, text, 335, 205);
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		guiGraphics.text(this.font, Component.translatable("gui.palamod.crushergui.label_paladium_crusher"), 121, 3, -3407821, false);
		guiGraphics.text(this.font, Component.translatable("gui.palamod.crushergui.label_inventaire"), 14, 109, -1315861, false);
		guiGraphics.text(this.font, Component.translatable("gui.palamod.crushergui.label_fuel"), 27, 58, -3394816, false);
		guiGraphics.text(this.font, Component.translatable("gui.palamod.crushergui.label_fruits"), 26, 24, -3407668, false);
		guiGraphics.text(this.font, Component.translatable("gui.palamod.crushergui.label_v2004"), 299, 192, -1, false);
		if (Crushertextad4Procedure.execute(world, x, y, z))
			guiGraphics.text(this.font, CrushercustominfoameProcedure.execute(world, x, y, z), 101, 38, -1, false);
		if (Crushertextad3Procedure.execute(world, x, y, z))
			guiGraphics.text(this.font, CrushercustominfotitaneProcedure.execute(world, x, y, z), 100, 72, -1, false);
		if (Crushertextad2Procedure.execute(world, x, y, z))
			guiGraphics.text(this.font, CrushercustominfopaladiumProcedure.execute(world, x, y, z), 220, 38, -1, false);
		if (CrushertextadProcedure.execute(world, x, y, z))
			guiGraphics.text(this.font, CrushercustominfoendiumProcedure.execute(world, x, y, z), 221, 72, -1, false);
	}

	@Override
	public void init() {
		super.init();
		imagebutton_button_white3 = new ImageButton(this.leftPos + 101, this.topPos + 52, 92, 20, new WidgetSprites(Identifier.parse("palamod:textures/screens/button_white.png"), Identifier.parse("palamod:textures/screens/button_gray.png")), e -> {
		...
		imagebutton_button_white4 = new ImageButton(this.leftPos + 215, this.topPos + 52, 92, 20, new WidgetSprites(Identifier.parse("palamod:textures/screens/button_white.png"), Identifier.parse("palamod:textures/screens/button_blue.png")), e -> {
			int x = CrusherguiScreen.this.x;
			int y = CrusherguiScreen.this.y;
		...
		imagebutton_button_white5 = new ImageButton(this.leftPos + 101, this.topPos + 20, 92, 20, new WidgetSprites(Identifier.parse("palamod:textures/screens/button_white.png"), Identifier.parse("palamod:textures/screens/button_purple.png")), e -> {
			int x = CrusherguiScreen.this.x;
			int y = CrusherguiScreen.this.y;
		...
		imagebutton_button_white6 = new ImageButton(this.leftPos + 215, this.topPos + 20, 92, 20, new WidgetSprites(Identifier.parse("palamod:textures/screens/button_white.png"), Identifier.parse("palamod:textures/screens/button_red.png")), e -> {
			int x = CrusherguiScreen.this.x;
			int y = CrusherguiScreen.this.y;
		...
		imagebutton_crusher_btn_pctg_on = new ImageButton(this.leftPos + 139, this.topPos + 99, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/crusher_btn_pctg_on.png"), Identifier.parse("palamod:textures/screens/crusher_btn_pctg_on_hover.png")), e -> {
					int x = CrusherguiScreen.this.x;
					int y = CrusherguiScreen.this.y;
					if (true) {
		...
		imagebutton_pro_mode_crusher = new ImageButton(this.leftPos + 112, this.topPos + 99, 24, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/pro_mode_crusher.png"), Identifier.parse("palamod:textures/screens/pro_mode_crusher_hover.png")), e -> {
					int x = CrusherguiScreen.this.x;
					int y = CrusherguiScreen.this.y;
					if (true) {
		...
		imagebutton_book_button = new ImageButton(this.leftPos + 14, this.topPos + 87, 20, 18, new WidgetSprites(Identifier.parse("palamod:textures/screens/book_button.png"), Identifier.parse("palamod:textures/screens/book_button_hover.png")), e -> {
			int x = CrusherguiScreen.this.x;
			int y = CrusherguiScreen.this.y;
			if (IscrushercrusherpromodefalseProcedure.execute(world, x, y, z)) {
