...
public class CrushercraftpalahelpguiScreen extends AbstractContainerScreen<CrushercraftpalahelpguiMenu> implements PalamodModScreens.ScreenAccessor {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 21 && mouseX < leftPos + 39 && mouseY > topPos + 8 && mouseY < topPos + 26) {
			guiGraphics.renderTooltip(font, Component.translatable("gui.palamod.crushercraftpalahelpgui.tooltip_fruits_slot_input"), mouseX, mouseY);
			customTooltipShown = true;
		}
		if (mouseX > leftPos + 21 && mouseX < leftPos + 39 && mouseY > topPos + 44 && mouseY < topPos + 62) {
			guiGraphics.renderTooltip(font, Component.translatable("gui.palamod.crushercraftpalahelpgui.tooltip_fuel_slot_input"), mouseX, mouseY);
			customTooltipShown = true;
		}
		if (mouseX > leftPos + 90 && mouseX < leftPos + 108 && mouseY > topPos + 44 && mouseY < topPos + 62) {
			guiGraphics.renderTooltip(font, Component.translatable("gui.palamod.crushercraftpalahelpgui.tooltip_crushers_output_slot"), mouseX, mouseY);
			customTooltipShown = true;
		}
		...
		if (mouseX > leftPos + 114 && mouseX < leftPos + 169 && mouseY > topPos + 27 && mouseY < topPos + 73) {
			guiGraphics.renderTooltip(font, Component.translatable("gui.palamod.crushercraftpalahelpgui.tooltip_crusher_progression_bar"), mouseX, mouseY);
			customTooltipShown = true;
		}
		if (mouseX > leftPos + 68 && mouseX < leftPos + 154 && mouseY > topPos + 6 && mouseY < topPos + 27) {
			guiGraphics.renderTooltip(font, Component.translatable("gui.palamod.crushercraftpalahelpgui.tooltip_click_on_me_once_on_the_bar_your"), mouseX, mouseY);
			customTooltipShown = true;
		}
		if (mouseX > leftPos + 142 && mouseX < leftPos + 153 && mouseY > topPos + -22 && mouseY < topPos + -7) {
			guiGraphics.renderTooltip(font, Component.translatable("gui.palamod.crushercraftpalahelpgui.tooltip_help_with_the_crusher"), mouseX, mouseY);
			customTooltipShown = true;
		}
		if (mouseX > leftPos + 22 && mouseX < leftPos + 38 && mouseY > topPos + -19 && mouseY < topPos + -7) {
			guiGraphics.renderTooltip(font, Component.translatable("gui.palamod.crushercraftpalahelpgui.tooltip_amethyst_craft"), mouseX, mouseY);
			customTooltipShown = true;
		}
		if (mouseX > leftPos + 51 && mouseX < leftPos + 67 && mouseY > topPos + -19 && mouseY < topPos + -7) {
			guiGraphics.renderTooltip(font, Component.translatable("gui.palamod.crushercraftpalahelpgui.tooltip_titane_craft"), mouseX, mouseY);
			customTooltipShown = true;
		}
		if (mouseX > leftPos + 78 && mouseX < leftPos + 93 && mouseY > topPos + -19 && mouseY < topPos + -7) {
			guiGraphics.renderTooltip(font, Component.translatable("gui.palamod.crushercraftpalahelpgui.tooltip_paladium_craft"), mouseX, mouseY);
			customTooltipShown = true;
		}
		if (mouseX > leftPos + 105 && mouseX < leftPos + 121 && mouseY > topPos + -21 && mouseY < topPos + -6) {
			guiGraphics.renderTooltip(font, Component.translatable("gui.palamod.crushercraftpalahelpgui.tooltip_endium_nugget_craft"), mouseX, mouseY);
			customTooltipShown = true;
		}
		if (mouseX > leftPos + 23 && mouseX < leftPos + 37 && mouseY > topPos + 28 && mouseY < topPos + 43) {
			guiGraphics.renderTooltip(font, Component.translatable("gui.palamod.crushercraftpalahelpgui.tooltip_fuel_progressbar"), mouseX, mouseY);
			customTooltipShown = true;
		}
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiGraphics.blit(ResourceLocation.parse("palamod:textures/screens/crusher_jei.png"), this.leftPos + 0, this.topPos + 0, 0, 0, 256, 256, 256, 256);
