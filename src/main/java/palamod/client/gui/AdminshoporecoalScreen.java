...
public class AdminshoporecoalScreen extends AbstractContainerScreen<AdminshoporecoalMenu> implements PalamodModScreens.ScreenAccessor {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, AdshoppreviewamountcoalProcedure.execute(world, entity), 29, 74, -4671036, false);
	...
	public void init() {
		...
		number_buy.setHint(Component.translatable("gui.palamod.adminshoporecoal.number_buy"));
		this.addWidget(this.number_buy);
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshoporecoal.button_buy"), e -> {
			int x = AdminshoporecoalScreen.this.x;
			int y = AdminshoporecoalScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshoporecoalButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshoporecoal.button_sell"), e -> {
			...
			int y = AdminshoporecoalScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshoporecoalButtonMessage(1, x, y, z));
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 155, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/cross_no_button.png"), ResourceLocation.parse("palamod:textures/screens/pointed_cross_no_button.png")), e -> {
					...
					int y = AdminshoporecoalScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshoporecoalButtonMessage(3, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 135, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/arrow_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/arrow_adminshop_poi.png")), e -> {
					...
					int y = AdminshoporecoalScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshoporecoalButtonMessage(4, x, y, z));
		...
		imagebutton_home_pixel_adminshop = new ImageButton(this.leftPos + 119, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/home_pixel_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/pointec_home_pixel_adminshop.png")), e -> {
					...
					int y = AdminshoporecoalScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshoporecoalButtonMessage(5, x, y, z));
