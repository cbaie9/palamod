	...
	public void init() {
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 155, this.topPos + 4, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/cross_no_button.png"), ResourceLocation.parse("palamod:textures/screens/pointed_cross_no_button.png")), e -> {
					...
					int y = AdminshoporecoalScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new AdminshoporecoalButtonMessage(2, x, y, z));
						AdminshoporecoalButtonMessage.handleButtonAction(entity, 2, x, y, z);
					}
				}) {
			@Override
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 135, this.topPos + 4, 17, 17,
