...
public class AdminshopplantcarrotScreen extends AbstractContainerScreen<AdminshopplantcarrotMenu> implements PalamodModScreens.ScreenAccessor {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, AdshoppreviewamountcarrotProcedure.execute(world, entity), 29, 77, -4671036, false);
	}
	...
	public void init() {
		...
		number_buy.setHint(Component.translatable("gui.palamod.adminshopplantcarrot.number_buy"));
		...
		button_buy = Button.builder(Component.translatable("gui.palamod.adminshopplantcarrot.button_buy"), e -> {
			int x = AdminshopplantcarrotScreen.this.x;
			int y = AdminshopplantcarrotScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshopplantcarrotButtonMessage(0, x, y, z));
		...
		button_sell = Button.builder(Component.translatable("gui.palamod.adminshopplantcarrot.button_sell"), e -> {
			...
			int y = AdminshopplantcarrotScreen.this.y;
			if (true) {
				ClientPacketDistributor.sendToServer(new AdminshopplantcarrotButtonMessage(1, x, y, z));
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 154, this.topPos + 5, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/cross_no_button.png"), ResourceLocation.parse("palamod:textures/screens/pointed_cross_no_button.png")), e -> {
					...
					int y = AdminshopplantcarrotScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshopplantcarrotButtonMessage(2, x, y, z));
		...
		imagebutton_arrow_adminshop = new ImageButton(this.leftPos + 135, this.topPos + 5, 16, 16,
				new WidgetSprites(ResourceLocation.parse("palamod:textures/screens/arrow_adminshop.png"), ResourceLocation.parse("palamod:textures/screens/arrow_adminshop_poi.png")), e -> {
					...
					int y = AdminshopplantcarrotScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new AdminshopplantcarrotButtonMessage(3, x, y, z));
