...
public class AdminshopplantcactusScreen extends AbstractContainerScreen<AdminshopplantcactusMenu> {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 134 && mouseX < leftPos + 149 && mouseY > topPos + 6 && mouseY < topPos + 20)
			guiGraphics.renderTooltip(font, Component.translatable("gui.palamod.adminshopplantcactus.tooltip_return_to_the_adminshop_plant_me"), mouseX, mouseY);
		if (mouseX > leftPos + 117 && mouseX < leftPos + 129 && mouseY > topPos + 5 && mouseY < topPos + 20)
			guiGraphics.renderTooltip(font, Component.translatable("gui.palamod.adminshopplantcactus.tooltip_return_to_the_adminshop_menu"), mouseX, mouseY);
	}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font,
				...
				AdshoppreviewamountcactusProcedure.execute(world, entity, guistate), 29, 74, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.palamod.adminshopplantcactus.label_sell_price_120"), 25, 30, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.palamod.adminshopplantcactus.label_buy_price_125"), 25, 44, -12829636, false);
	}
