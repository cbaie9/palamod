...
public class AnalyserloadingScreen extends AbstractContainerScreen<AnalyserloadingMenu> implements PalamodModScreens.ScreenAccessor {
	...
	private static final ResourceLocation IMAGE_0 = ResourceLocation.parse("palamod:textures/screens/analyserloading.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiGraphics.blit(IMAGE_0, this.leftPos + -1, this.topPos + 0, 0, 0, 150, 100, 150, 100);
