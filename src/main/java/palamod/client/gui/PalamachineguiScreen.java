...
public class PalamachineguiScreen extends AbstractContainerScreen<PalamachineguiMenu> implements PalamodModScreens.ScreenAccessor {
	...
	private static final Identifier IMAGE_0 = Identifier.parse("palamod:textures/screens/palamachinegui.png");
	private static final Identifier SPRITE_0 = Identifier.parse("palamod:textures/screens/circle_sprite_palamachine.png");
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		guiGraphics.text(this.font, Component.translatable("gui.palamod.palamachinegui.label_palamachine"), 3, 3, -3407872, false);
		guiGraphics.text(this.font, Grindertrans0Procedure.execute(), 4, 84, -4671036, false);
	}
