...
public class LuckyguiScreen extends AbstractContainerScreen<LuckyguiMenu> implements PalamodModScreens.ScreenAccessor {
	...
	private static final Identifier IMAGE_0 = Identifier.parse("palamod:textures/screens/luckygui.png");
	...
	public void extractBackground(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_0, this.leftPos + -1, this.topPos + 0, 0, 0, 176, 180, 176, 180);
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_1, this.leftPos + -1, this.topPos + 0, 0, 0, 100, 24, 100, 24);
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_2, this.leftPos + 75, this.topPos + 0, 0, 0, 100, 24, 100, 24);
	}
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		guiGraphics.text(this.font, Component.translatable("gui.palamod.luckygui.label_lucky_block"), 55, 6, -1, false);
		guiGraphics.text(this.font, LuckyblockgetnameProcedure.execute(world, x, y, z), 26, 84, -3407821, false);
	}
	...
	public void init() {
		...
		button_open = Button.builder(Component.translatable("gui.palamod.luckygui.button_open"), e -> {
			...
			if (true) {
				ClientPacketDistributor.sendToServer(new LuckyguiButtonMessage(0, x, y, z));
		...
		imagebutton_cross_no_button = new ImageButton(this.leftPos + 155, this.topPos + 4, 16, 16,
				new WidgetSprites(Identifier.parse("palamod:textures/screens/cross_no_button.png"), Identifier.parse("palamod:textures/screens/pointed_cross_no_button.png")), e -> {
					...
					int y = LuckyguiScreen.this.y;
					if (true) {
						ClientPacketDistributor.sendToServer(new LuckyguiButtonMessage(1, x, y, z));
