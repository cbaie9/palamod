...
public class Paladiumarmorcustom2Armor {
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
			private final Identifier armorTexture = Identifier.parse("palamod:textures/models/armor/paladium_c2_layer_1.png");
		...
		event.registerItem(new IClientItemExtensions() {
			private final Identifier armorTexture = Identifier.parse("palamod:textures/models/armor/paladium_c2_layer_2.png");
