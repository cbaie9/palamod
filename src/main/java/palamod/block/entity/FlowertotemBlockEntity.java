...
public class FlowertotemBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new FlowertotemguiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

	@Override
	public Component getDisplayName() {
		return Component.literal("Flower totem");
	}
