...
public class CobblebreakerserverBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new CobbleakerserverMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
